...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ao(e,t,n){let r=new Float32Array(Ga),i=new U(0,1,0);return new Ai({name:`SphericalGaussianBlur`,defines:{n:Ga,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:co(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function oo(){return new Ai({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:co(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function so(){return new Ai({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:co(),fragmentShader:`
	...
	`}var lo=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ci(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
}`,zc=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new fi(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new Ai({vertexShader:Lc,fragmentShader:Rc,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new q(new yi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Bc=class extends tt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,u=null,d=null,f=null,p=null,h=null,g=typeof XRWebGLBinding<`u`,_=new zc,v={},b=t.getContextAttributes(),x=null,S=null,C=[],D=[],ee=new H,O=null,k=new ua;k.viewport=new Gt;let te=new ua;te.viewport=new Gt;let A=[k,te],j=new _a,ne=null,re=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new Dn,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new Dn,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new Dn,C[e]=t),t.getHandSpace()};function M(e){let t=D.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ie(){r.removeEventListener(`select`,M),r.removeEventListener(`selectstart`,M),r.removeEventListener(`selectend`,M),r.removeEventListener(`squeeze`,M),r.removeEventListener(`squeezestart`,M),r.removeEventListener(`squeezeend`,M),r.removeEventListener(`end`,ie),r.removeEventListener(`inputsourceschange`,ae);for(let e=0;e<C.length;e++){let t=D[e];t!==null&&(D[e]=null,C[e].disconnect(t))}ne=null,re=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(x),p=null,f=null,d=null,r=null,S=null,fe.stop(),n.isPresenting=!1,e.setPixelRatio(O),e.setSize(ee.width,ee.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&z(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&z(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return h},this.getSession=function(){return r},this.setSession=async function(u){if(r=u,r!==null){if(x=e.getRenderTarget(),r.addEventListener(`select`,M),r.addEventListener(`selectstart`,M),r.addEventListener(`selectend`,M),r.addEventListener(`squeeze`,M),r.addEventListener(`squeezestart`,M),r.addEventListener(`squeezeend`,M),r.addEventListener(`end`,ie),r.addEventListener(`inputsourceschange`,ae),b.xrCompatible!==!0&&await t.makeXRCompatible(),O=e.getPixelRatio(),e.getSize(ee),g&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;b.depth&&(o=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=b.stencil?E:T,a=b.stencil?y:m);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};d=this.getBinding(),f=d.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new qt(f.textureWidth,f.textureHeight,{format:w,type:l,depthTexture:new ui(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new qt(p.framebufferWidth,p.framebufferHeight,{format:w,type:l,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),fe.setContext(r),fe.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function ae(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=D.indexOf(n);r>=0&&(D[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=D.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=D.length){D.push(n),r=e;break}else if(D[e]===null){D[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let oe=new U,se=new U;function N(e,t,n){oe.setFromMatrixPosition(t.matrixWorld),se.setFromMatrixPosition(n.matrixWorld);let r=oe.distanceTo(se),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function ce(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),j.near=te.near=k.near=t,j.far=te.far=k.far=n,(ne!==j.near||re!==j.far)&&(r.updateRenderState({depthNear:j.near,depthFar:j.far}),ne=j.near,re=j.far),j.layers.mask=e.layers.mask|6,k.layers.mask=j.layers.mask&-5,te.layers.mask=j.layers.mask&-3;let i=e.parent,a=j.cameras;ce(j,i);for(let e=0;e<a.length;e++)ce(a[e],i);a.length===2?N(j,k,te):j.projectionMatrix.copy(k.projectionMatrix),le(e,j,i)};function le(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=at*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return j},this.getFoveation=function(){if(!(f===null&&p===null))return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(j)},this.getCameraTexture=function(e){return v[e]};let ue=null;function de(t,i){if(u=i.getViewerPose(c||a),h=i,u!==null){let t=u.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==j.cameras.length&&(j.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=d.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=A[n];o===void 0&&(o=new ua,o.layers.enable(n),o.viewport=new Gt,A[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(j.matrix.copy(o.matrix),j.matrix.decompose(j.position,j.quaternion,j.scale)),i===!0&&j.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&g){d=n.getBinding();let e=d.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&g){e.state.unbindTexture(),d=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new fi,v[n]=e);let t=d.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=D[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}ue&&ue(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),h=null}let fe=new Ma;fe.setAnimationLoop(de),this.setAnimationLoop=function(e){ue=e},this.dispose=function(){}}},Vc=new Xt,Hc=new W;Hc.set(-1,0,0,0,1,0,0,0,1);function Uc(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,Ei(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(Vc.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(Hc),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function Wc(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(m(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,g));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return B(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let t=0,n=r.length;t<n;t++){let n=Array.isArray(r[t])?r[t]:[r[t]];for(let r=0,i=n.length;r<i;r++){let i=n[r];if(p(i,t,r,a)===!0){let t=i.__offset,n=Array.isArray(i.value)?i.value:[i.value],r=0;for(let a=0;a<n.length;a++){let o=n[a],s=h(o);typeof o==`number`||typeof o==`boolean`?(i.__data[0]=o,e.bufferSubData(e.UNIFORM_BUFFER,t+r,i.__data)):o.isMatrix3?(i.__data[0]=o.elements[0],i.__data[1]=o.elements[1],i.__data[2]=o.elements[2],i.__data[3]=0,i.__data[4]=o.elements[3],i.__data[5]=o.elements[4],i.__data[6]=o.elements[5],i.__data[7]=0,i.__data[8]=o.elements[6],i.__data[9]=o.elements[7],i.__data[10]=o.elements[8],i.__data[11]=0):ArrayBuffer.isView(o)?i.__data.set(new o.constructor(o.buffer,o.byteOffset,i.__data.length)):(o.toArray(i.__data,r),r+=s.storage/Float32Array.BYTES_PER_ELEMENT)}e.bufferSubData(e.UNIFORM_BUFFER,t,i.__data)}}}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:ArrayBuffer.isView(i)?r[a]=i.slice():r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function m(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=h(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function h(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?z(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):z(`WebGLRenderer: Unsupported uniform value type.`,e),t}function g(t){let n=t.target;n.removeEventListener(`dispose`,g);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function _(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:_}}var Gc=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Kc=null;function qc(){return Kc===null&&(Kc=new $r(Gc,16,16,O,g),Kc.name=`DFG_LUT`,Kc.minFilter=o,Kc.magFilter=o,Kc.wrapS=t,Kc.wrapT=t,Kc.generateMipmaps=!1,Kc.needsUpdate=!0),Kc}var Jc=class{constructor(e={}){let{canvas:t=qe(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:u=!1,powerPreference:d=`default`,failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:b=l}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);x=n.getContextAttributes().alpha}else x=a;let S=b,C=new Set([te,k,ee]),w=new Set([l,m,f,y,_,v]),T=new Uint32Array(4),E=new Int32Array(4),D=new U,O=null,A=null,j=[],ne=[],re=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let M=this,ie=!1,ae=null;this._outputColorSpace=Le;let oe=0,se=0,N=null,ce=-1,le=null,ue=new Gt,de=new Gt,fe=null,pe=new K(0),me=0,he=t.width,ge=t.height,_e=1,ve=null,ye=null,be=new Gt(0,0,he,ge),xe=new Gt(0,0,he,ge),Se=!1,Ce=new si,we=!1,Te=!1,Ee=new Xt,De=new U,Oe=new Gt,ke={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Ae=!1;function je(){return N===null?_e:1}let P=n;function Me(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:p};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r184`),t.addEventListener(`webglcontextlost`,at,!1),t.addEventListener(`webglcontextrestored`,ot,!1),t.addEventListener(`webglcontextcreationerror`,V,!1),P===null){let t=`webgl2`;if(P=Me(t,e),P===null)throw Me(t)?Error(`Error creating WebGL context with your selected attributes.`):Error(`Error creating WebGL context.`)}}catch(e){throw B(`WebGLRenderer: `+e.message),e}let F,Ne,I,Pe,L,R,Fe,Ie,Re,ze,Be,Ve,He,We,Ge,Ke,Je,Ye,Ze,Qe,et,tt,nt;function rt(){F=new fo(P),F.init(),et=new Ic(P,F),Ne=new Va(P,F,e,et),I=new Pc(P,F),Ne.reversedDepthBuffer&&h&&I.buffers.depth.setReversed(!0),Pe=new ho(P),L=new mc,R=new Fc(P,F,I,L,Ne,et,Pe),Fe=new uo(M),Ie=new Na(P),tt=new za(P,Ie),Re=new po(P,Ie,Pe,tt),ze=new _o(P,Re,Ie,tt,Pe),Ye=new go(P,Ne,R),Ge=new Ha(L),Be=new pc(M,Fe,F,Ne,tt,Ge),Ve=new Uc(M,L),He=new vc,We=new Tc(F),Je=new Ra(M,Fe,I,ze,x,s),Ke=new Nc(M,ze,Ne),nt=new Wc(P,Pe,Ne,I),Ze=new Ba(P,F,Pe),Qe=new mo(P,F,Pe),Pe.programs=Be.programs,M.capabilities=Ne,M.extensions=F,M.properties=L,M.renderLists=He,M.shadowMap=Ke,M.state=I,M.info=Pe}rt(),S!==1009&&(re=new yo(S,t.width,t.height,r,i));let it=new Bc(M,P);this.xr=it,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){let e=F.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=F.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return _e},this.setPixelRatio=function(e){e!==void 0&&(_e=e,this.setSize(he,ge,!1))},this.getSize=function(e){return e.set(he,ge)},this.setSize=function(e,n,r=!0){if(it.isPresenting){z(`WebGLRenderer: Can't change size while VR device is presenting.`);return}he=e,ge=n,t.width=Math.floor(e*_e),t.height=Math.floor(n*_e),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),re!==null&&re.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(he*_e,ge*_e).floor()},this.setDrawingBufferSize=function(e,n,r){he=e,ge=n,_e=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){B(`THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){z(`THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}re.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(ue)},this.getViewport=function(e){return e.copy(be)},this.setViewport=function(e,t,n,r){e.isVector4?be.set(e.x,e.y,e.z,e.w):be.set(e,t,n,r),I.viewport(ue.copy(be).multiplyScalar(_e).round())},this.getScissor=function(e){return e.copy(xe)},this.setScissor=function(e,t,n,r){e.isVector4?xe.set(e.x,e.y,e.z,e.w):xe.set(e,t,n,r),I.scissor(de.copy(xe).multiplyScalar(_e).round())},this.getScissorTest=function(){return Se},this.setScissorTest=function(e){I.setScissorTest(Se=e)},this.setOpaqueSort=function(e){ve=e},this.setTransparentSort=function(e){ye=e},this.getClearColor=function(e){return e.copy(Je.getClearColor())},this.setClearColor=function(){Je.setClearColor(...arguments)},this.getClearAlpha=function(){return Je.getClearAlpha()},this.setClearAlpha=function(){Je.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(N!==null){let t=N.texture.format;e=C.has(t)}if(e){let e=N.texture.type,t=w.has(e),n=Je.getClearColor(),r=Je.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,P.clearBufferuiv(P.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,P.clearBufferiv(P.COLOR,0,E))}else r|=P.COLOR_BUFFER_BIT}t&&(r|=P.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&P.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),ae=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,at,!1),t.removeEventListener(`webglcontextrestored`,ot,!1),t.removeEventListener(`webglcontextcreationerror`,V,!1),Je.dispose(),He.dispose(),We.dispose(),L.dispose(),Fe.dispose(),ze.dispose(),tt.dispose(),nt.dispose(),Be.dispose(),it.dispose(),it.removeEventListener(`sessionstart`,pt),it.removeEventListener(`sessionend`,mt),ht.stop()};function at(e){e.preventDefault(),Xe(`WebGLRenderer: Context Lost.`),ie=!0}function ot(){Xe(`WebGLRenderer: Context Restored.`),ie=!1;let e=Pe.autoReset,t=Ke.enabled,n=Ke.autoUpdate,r=Ke.needsUpdate,i=Ke.type;rt(),Pe.autoReset=e,Ke.enabled=t,Ke.autoUpdate=n,Ke.needsUpdate=r,Ke.type=i}function V(e){B(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function st(e){let t=e.target;t.removeEventListener(`dispose`,st),ct(t)}function ct(e){lt(e),L.remove(e)}function lt(e){let t=L.get(e).programs;t!==void 0&&(t.forEach(function(e){Be.releaseProgram(e)}),e.isShaderMaterial&&Be.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=ke);let o=i.isMesh&&i.matrixWorld.determinant()<0,s=Tt(e,t,n,r,i);I.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Re.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;tt.setup(i,r,s,n,c);let h,g=Ze;if(c!==null&&(h=Ie.get(c),g=Qe,g.setIndex(h)),i.isMesh)r.wireframe===!0?(I.setLineWidth(r.wireframeLinewidth*je()),g.setMode(P.LINES)):g.setMode(P.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),I.setLineWidth(e*je()),i.isLineSegments?g.setMode(P.LINES):i.isLineLoop?g.setMode(P.LINE_LOOP):g.setMode(P.LINE_STRIP)}else i.isPoints?g.setMode(P.POINTS):i.isSprite&&g.setMode(P.TRIANGLES);if(i.isBatchedMesh)if(F.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Ie.get(c).bytesPerElement:1,o=L.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(P,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function ut(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,xt(e,t,n),e.side=0,e.needsUpdate=!0,xt(e,t,n),e.side=2):xt(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),A=We.get(n),A.init(t),ne.push(A),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(A.pushLight(e),e.castShadow&&A.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(A.pushLight(e),e.castShadow&&A.pushShadow(e))}),A.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];ut(a,n,e),r.add(a)}else ut(t,n,e),r.add(t)}),A=ne.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){L.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}F.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let dt=null;function ft(e){dt&&dt(e)}function pt(){ht.stop()}function mt(){ht.start()}let ht=new Ma;ht.setAnimationLoop(ft),typeof self<`u`&&ht.setContext(self),this.setAnimationLoop=function(e){dt=e,it.setAnimationLoop(e),e===null?ht.stop():ht.start()},it.addEventListener(`sessionstart`,pt),it.addEventListener(`sessionend`,mt),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){B(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ie===!0)return;ae!==null&&ae.renderStart(e,t);let n=it.enabled===!0&&it.isPresenting===!0,r=re!==null&&(N===null||n)&&re.begin(M,N);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),it.enabled===!0&&it.isPresenting===!0&&(re===null||re.isCompositing()===!1)&&(it.cameraAutoUpdate===!0&&it.updateCamera(t),t=it.getCamera()),e.isScene===!0&&e.onBeforeRender(M,e,t,N),A=We.get(e,ne.length),A.init(t),A.state.textureUnits=R.getTextureUnits(),ne.push(A),Ee.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),Ce.setFromProjectionMatrix(Ee,Ue,t.reversedDepth),Te=this.localClippingEnabled,we=Ge.init(this.clippingPlanes,Te),O=He.get(e,j.length),O.init(),j.push(O),it.enabled===!0&&it.isPresenting===!0){let e=M.xr.getDepthSensingMesh();e!==null&&gt(e,t,-1/0,M.sortObjects)}gt(e,t,0,M.sortObjects),O.finish(),M.sortObjects===!0&&O.sort(ve,ye),Ae=it.enabled===!1||it.isPresenting===!1||it.hasDepthSensing()===!1,Ae&&Je.addToRenderList(O,e),this.info.render.frame++,we===!0&&Ge.beginShadows();let i=A.state.shadowsArray;if(Ke.render(i,e,t),we===!0&&Ge.endShadows(),this.info.autoReset===!0&&this.info.reset(),(r&&re.hasRenderPass())===!1){let n=O.opaque,r=O.transmissive;if(A.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];vt(n,r,e,a)}Ae&&Je.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];_t(O,e,n,n.viewport)}}else r.length>0&&vt(n,r,e,t),Ae&&Je.render(e),_t(O,e,t)}N!==null&&se===0&&(R.updateMultisampleRenderTarget(N),R.updateRenderTargetMipmap(N)),r&&re.end(M),e.isScene===!0&&e.onAfterRender(M,e,t),tt.resetDefaultState(),ce=-1,le=null,ne.pop(),ne.length>0?(A=ne[ne.length-1],R.setTextureUnits(A.state.textureUnits),we===!0&&Ge.setGlobalState(M.clippingPlanes,A.state.camera)):A=null,j.pop(),O=j.length>0?j[j.length-1]:null,ae!==null&&ae.renderEnd()};function gt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)A.pushLightProbeGrid(e);else if(e.isLight)A.pushLight(e),e.castShadow&&A.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||Ce.intersectsSprite(e)){r&&Oe.setFromMatrixPosition(e.matrixWorld).applyMatrix4(Ee);let t=ze.update(e),i=e.material;i.visible&&O.push(e,t,i,n,Oe.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||Ce.intersectsObject(e))){let t=ze.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),Oe.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Oe.copy(e.boundingSphere.center)),Oe.applyMatrix4(e.matrixWorld).applyMatrix4(Ee)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&O.push(e,t,s,n,Oe.z,o)}}else i.visible&&O.push(e,t,i,n,Oe.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)gt(i[e],t,n,r)}function _t(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;A.setupLightsView(n),we===!0&&Ge.setGlobalState(M.clippingPlanes,n),r&&I.viewport(ue.copy(r)),i.length>0&&yt(i,t,n),a.length>0&&yt(a,t,n),o.length>0&&yt(o,t,n),I.buffers.depth.setTest(!0),I.buffers.depth.setMask(!0),I.buffers.color.setMask(!0),I.setPolygonOffset(!1)}function vt(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[r.id]===void 0){let e=F.has(`EXT_color_buffer_half_float`)||F.has(`EXT_color_buffer_float`);A.state.transmissionRenderTarget[r.id]=new qt(1,1,{generateMipmaps:!0,type:e?g:l,minFilter:c,samples:Math.max(4,Ne.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:G.workingColorSpace})}let a=A.state.transmissionRenderTarget[r.id],o=r.viewport||ue;a.setSize(o.z*M.transmissionResolutionScale,o.w*M.transmissionResolutionScale);let s=M.getRenderTarget(),u=M.getActiveCubeFace(),d=M.getActiveMipmapLevel();M.setRenderTarget(a),M.getClearColor(pe),me=M.getClearAlpha(),me<1&&M.setClearColor(16777215,.5),M.clear(),Ae&&Je.render(n);let f=M.toneMapping;M.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),A.setupLightsView(r),we===!0&&Ge.setGlobalState(M.clippingPlanes,r),yt(e,n,r),R.updateMultisampleRenderTarget(a),R.updateRenderTargetMipmap(a),F.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,bt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(R.updateMultisampleRenderTarget(a),R.updateRenderTargetMipmap(a))}M.setRenderTarget(s,u,d),M.setClearColor(pe,me),p!==void 0&&(r.viewport=p),M.toneMapping=f}function yt(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&bt(o,t,n,s,l,c)}}function bt(e,t,n,r,i,a){e.onBeforeRender(M,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(M,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,M.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,M.renderBufferDirect(n,t,r,i,e,a),i.side=2):M.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(M,t,n,r,i,a)}function xt(e,t,n){t.isScene!==!0&&(t=ke);let r=L.get(e),i=A.state.lights,a=A.state.shadowsArray,o=i.state.version,s=Be.getParameters(e,i.state,a,t,n,A.state.lightProbeGridArray),c=Be.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Fe.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,st),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return Ct(e,s),d}else s.uniforms=Be.getUniforms(e),ae!==null&&e.isNodeMaterial&&ae.build(e,n,s),e.onBeforeCompile(s,M),d=Be.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Ge.uniform),Ct(e,s),r.needsLights=Dt(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=A.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function St(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=Es.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function Ct(e,t){let n=L.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function wt(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function Tt(e,t,n,r,i){t.isScene!==!0&&(t=ke),R.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=N===null?M.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:G.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Fe.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(h=M.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=L.get(r),y=A.state.lights;if(we===!0&&(Te===!0||e!==le)){let t=e===le&&r.id===ce;Ge.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Ge.numPlanes||v.numIntersection!==Ge.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=A.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=xt(r,t,i),ae&&r.isNodeMaterial&&ae.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(I.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==ce&&(ce=r.id,C=!0),v.needsLights){let e=wt(A.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||le!==e){I.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(P,`projectionMatrix`,e.projectionMatrix),T.setValue(P,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(P,De.setFromMatrixPosition(e.matrixWorld)),Ne.logarithmicDepthBuffer&&T.setValue(P,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(P,`isOrthographic`,e.isOrthographicCamera===!0),le!==e&&(le=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(P,`directionalShadowMap`,y.state.directionalShadowMap,R),y.state.spotShadowMap.length>0&&T.setValue(P,`spotShadowMap`,y.state.spotShadowMap,R),y.state.pointShadowMap.length>0&&T.setValue(P,`pointShadowMap`,y.state.pointShadowMap,R)),i.isSkinnedMesh){T.setOptional(P,i,`bindMatrix`),T.setOptional(P,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(P,`boneTexture`,e.boneTexture,R))}i.isBatchedMesh&&(T.setOptional(P,i,`batchingTexture`),T.setValue(P,`batchingTexture`,i._matricesTexture,R),T.setOptional(P,i,`batchingIdTexture`),T.setValue(P,`batchingIdTexture`,i._indirectTexture,R),T.setOptional(P,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(P,`batchingColorTexture`,i._colorsTexture,R));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&Ye.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(P,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=qc()),C){if(T.setValue(P,`toneMappingExposure`,M.toneMappingExposure),v.needsLights&&Et(E,w),a&&r.fog===!0&&Ve.refreshFogUniforms(E,a),Ve.refreshMaterialUniforms(E,r,_e,ge,A.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}Es.upload(P,St(v),E,R)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(Es.upload(P,St(v),E,R),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(P,`center`,i.center),T.setValue(P,`modelViewMatrix`,i.modelViewMatrix),T.setValue(P,`normalMatrix`,i.normalMatrix),T.setValue(P,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];nt.update(n,x),nt.bind(n,x)}}return x}function Et(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function Dt(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return oe},this.getActiveMipmapLevel=function(){return se},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(e,t,n){let r=L.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),L.get(e.texture).__webglTexture=t,L.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=L.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0};let H=P.createFramebuffer();this.setRenderTarget=function(e,t=0,n=0){N=e,oe=t,se=n;let r=null,i=!1,a=!1;if(e){let o=L.get(e);if(o.__useDefaultFramebuffer!==void 0){I.bindFramebuffer(P.FRAMEBUFFER,o.__webglFramebuffer),ue.copy(e.viewport),de.copy(e.scissor),fe=e.scissorTest,I.viewport(ue),I.scissor(de),I.setScissorTest(fe),ce=-1;return}else if(o.__webglFramebuffer===void 0)R.setupRenderTarget(e);else if(o.__hasExternalTextures)R.rebindTextures(e,L.get(e.texture).__webglTexture,L.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&L.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.`);R.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=L.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&R.useMultisampledRTT(e)===!1?L.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,ue.copy(e.viewport),de.copy(e.scissor),fe=e.scissorTest}else ue.copy(be).multiplyScalar(_e).floor(),de.copy(xe).multiplyScalar(_e).floor(),fe=Se;if(n!==0&&(r=H),I.bindFramebuffer(P.FRAMEBUFFER,r)&&I.drawBuffers(e,r),I.viewport(ue),I.scissor(de),I.setScissorTest(fe),i){let r=L.get(e.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=L.get(e.textures[t]);P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=L.get(e.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,t.__webglTexture,n)}ce=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){B(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=L.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){I.bindFramebuffer(P.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+s),!Ne.textureFormatReadable(c)){B(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Ne.textureTypeReadable(l)){B(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&P.readPixels(t,n,r,i,et.convert(c),et.convert(l),a)}finally{let e=N===null?null:L.get(N).__webglFramebuffer;I.bindFramebuffer(P.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=L.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){I.bindFramebuffer(P.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+s),!Ne.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Ne.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,d),P.bufferData(P.PIXEL_PACK_BUFFER,a.byteLength,P.STREAM_READ),P.readPixels(t,n,r,i,et.convert(l),et.convert(u),0);let f=N===null?null:L.get(N).__webglFramebuffer;I.bindFramebuffer(P.FRAMEBUFFER,f);let p=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await $e(P,p,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,d),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,a),P.deleteBuffer(d),P.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;R.setTexture2D(e,0),P.copyTexSubImage2D(P.TEXTURE_2D,n,0,0,o,s,i,a),I.unbindTexture()};let Ot=P.createFramebuffer(),kt=P.createFramebuffer();this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=et.convert(t.format),_=et.convert(t.type),v;t.isData3DTexture?(R.setTexture3D(t,0),v=P.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(R.setTexture2DArray(t,0),v=P.TEXTURE_2D_ARRAY):(R.setTexture2D(t,0),v=P.TEXTURE_2D),I.activeTexture(P.TEXTURE0),I.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,t.flipY),I.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),I.pixelStorei(P.UNPACK_ALIGNMENT,t.unpackAlignment);let y=I.getParameter(P.UNPACK_ROW_LENGTH),b=I.getParameter(P.UNPACK_IMAGE_HEIGHT),x=I.getParameter(P.UNPACK_SKIP_PIXELS),S=I.getParameter(P.UNPACK_SKIP_ROWS),C=I.getParameter(P.UNPACK_SKIP_IMAGES);I.pixelStorei(P.UNPACK_ROW_LENGTH,h.width),I.pixelStorei(P.UNPACK_IMAGE_HEIGHT,h.height),I.pixelStorei(P.UNPACK_SKIP_PIXELS,l),I.pixelStorei(P.UNPACK_SKIP_ROWS,u),I.pixelStorei(P.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=L.get(e),r=L.get(t),h=L.get(n.__renderTarget),g=L.get(r.__renderTarget);I.bindFramebuffer(P.READ_FRAMEBUFFER,h.__webglFramebuffer),I.bindFramebuffer(P.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,L.get(e).__webglTexture,i,d+n),P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,L.get(t).__webglTexture,a,m+n)),P.blitFramebuffer(l,u,o,s,f,p,o,s,P.DEPTH_BUFFER_BIT,P.NEAREST);I.bindFramebuffer(P.READ_FRAMEBUFFER,null),I.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||L.has(e)){let n=L.get(e),r=L.get(t);I.bindFramebuffer(P.READ_FRAMEBUFFER,Ot),I.bindFramebuffer(P.DRAW_FRAMEBUFFER,kt);for(let e=0;e<c;e++)w?P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):P.framebufferTexture2D(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,n.__webglTexture,i),T?P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):P.framebufferTexture2D(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,r.__webglTexture,a),i===0?T?P.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):P.copyTexSubImage2D(v,a,f,p,l,u,o,s):P.blitFramebuffer(l,u,o,s,f,p,o,s,P.COLOR_BUFFER_BIT,P.NEAREST);I.bindFramebuffer(P.READ_FRAMEBUFFER,null),I.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?P.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?P.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):P.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):P.texSubImage2D(P.TEXTURE_2D,a,f,p,o,s,g,_,h);I.pixelStorei(P.UNPACK_ROW_LENGTH,y),I.pixelStorei(P.UNPACK_IMAGE_HEIGHT,b),I.pixelStorei(P.UNPACK_SKIP_PIXELS,x),I.pixelStorei(P.UNPACK_SKIP_ROWS,S),I.pixelStorei(P.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&P.generateMipmap(v),I.unbindTexture()},this.initRenderTarget=function(e){L.get(e).__webglFramebuffer===void 0&&R.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?R.setTextureCube(e,0):e.isData3DTexture?R.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?R.setTexture2DArray(e,0):R.setTexture2D(e,0),I.unbindTexture()},this.resetState=function(){oe=0,se=0,N=null,I.reset(),tt.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Ue}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=G._getDrawingBufferColorSpace(e),t.unpackColorSpace=G._getUnpackColorSpace()}},Yc=class{stick;knob;dashButton;keys=new Set;pointer=new H;gamepadMove=new H;keyVector=new H;pointerState={active:!1,id:null,centerX:0,centerY:0,radius:1};dashDown=!1;gamepad=null;onKeyDown=e=>{this.keys.add(e.code),(e.code===`Space`||e.code===`ShiftLeft`||e.code===`ShiftRight`)&&(this.dashDown=!0)};onKeyUp=e=>{this.keys.delete(e.code),(e.code===`Space`||e.code===`ShiftLeft`||e.code===`ShiftRight`)&&(this.dashDown=!1)};onStickDown=e=>{e.preventDefault();let t=this.stick.getBoundingClientRect();this.pointerState.active=!0,this.pointerState.id=e.pointerId,this.pointerState.centerX=t.left+t.width/2,this.pointerState.centerY=t.top+t.height/2,this.pointerState.radius=t.width*.42;try{this.stick.setPointerCapture(e.pointerId)}catch{}this.updatePointer(e.clientX,e.clientY)};onStickMove=e=>{!this.pointerState.active||e.pointerId!==this.pointerState.id||(e.preventDefault(),this.updatePointer(e.clientX,e.clientY))};onStickUp=e=>{e.pointerId===this.pointerState.id&&(e.preventDefault(),this.pointerState.active=!1,this.pointerState.id=null,this.pointer.set(0,0),this.updateKnob())};onDashDown=e=>{e.preventDefault(),this.dashDown=!0};onDashUp=e=>{e.preventDefault(),this.dashDown=!1};constructor(e,t,n){this.stick=e,this.knob=t,this.dashButton=n,window.addEventListener(`keydown`,this.onKeyDown),window.addEventListener(`keyup`,this.onKeyUp),this.stick.addEventListener(`pointerdown`,this.onStickDown),this.stick.addEventListener(`pointermove`,this.onStickMove),this.stick.addEventListener(`pointerup`,this.onStickUp),this.stick.addEventListener(`pointercancel`,this.onStickUp),this.dashButton.addEventListener(`pointerdown`,this.onDashDown),this.dashButton.addEventListener(`pointerup`,this.onDashUp),this.dashButton.addEventListener(`pointercancel`,this.onDashUp),this.dashButton.addEventListener(`pointerleave`,this.onDashUp)}setGamepad(e){this.gamepad=e}readMovement(e){return this.keyVector.set(0,0),(this.keys.has(`KeyA`)||this.keys.has(`ArrowLeft`))&&--this.keyVector.x,(this.keys.has(`KeyD`)||this.keys.has(`ArrowRight`))&&(this.keyVector.x+=1),(this.keys.has(`KeyW`)||this.keys.has(`ArrowUp`))&&--this.keyVector.y,(this.keys.has(`KeyS`)||this.keys.has(`ArrowDown`))&&(this.keyVector.y+=1),this.gamepad?this.gamepad.readMove(this.gamepadMove):this.gamepadMove.set(0,0),e.copy(this.keyVector).add(this.pointer).add(this.gamepadMove),e.lengthSq()>1&&e.normalize(),e}isDashHeld(){return this.dashDown||(this.gamepad?.isDashHeld()??!1)}dispose(){window.removeEventListener(`keydown`,this.onKeyDown),window.removeEventListener(`keyup`,this.onKeyUp),this.stick.removeEventListener(`pointerdown`,this.onStickDown),this.stick.removeEventListener(`pointermove`,this.onStickMove),this.stick.removeEventListener(`pointerup`,this.onStickUp),this.stick.removeEventListener(`pointercancel`,this.onStickUp),this.dashButton.removeEventListener(`pointerdown`,this.onDashDown),this.dashButton.removeEventListener(`pointerup`,this.onDashUp),this.dashButton.removeEventListener(`pointercancel`,this.onDashUp),this.dashButton.removeEventListener(`pointerleave`,this.onDashUp)}updatePointer(e,t){let n=e-this.pointerState.centerX,r=t-this.pointerState.centerY;this.pointer.set(n/this.pointerState.radius,r/this.pointerState.radius),this.pointer.lengthSq()>1&&this.pointer.normalize(),this.updateKnob()}updateKnob(){this.knob.style.transform=`translate(calc(-50% + ${this.pointer.x*38}px), calc(-50% + ${this.pointer.y*38}px))`}},Xc=.18,Zc=.1,Qc={A:0,B:1,X:2,Y:3,LB:4,RB:5,BACK:8,START:9,DPAD_UP:12,DPAD_DOWN:13,DPAD_LEFT:14,DPAD_RIGHT:15},$c=class{pad=null;prevButtons=[];stateListeners=new Set;status={connected:!1,index:null,id:null,mapping:null,lastActivity:0};constructor(){window.addEventListener(`gamepadconnected`,this.handleConnect),window.addEventListener(`gamepaddisconnected`,this.handleDisconnect),this.tryAdoptExisting()}onStatusChange(e){return this.stateListeners.add(e),e(this.status),()=>{this.stateListeners.delete(e)}}getStatus(){return this.status}readMove(e){if(!this.pad)return e.set(0,0);let t=el(this.pad.axes[0]??0,Xc),n=el(this.pad.axes[1]??0,Xc);if(e.set(t,-n),e.lengthSq()<1e-4){let t=this.buttonDown(Qc.DPAD_RIGHT)?1:this.buttonDown(Qc.DPAD_LEFT)?-1:0,n=this.buttonDown(Qc.DPAD_DOWN)?1:this.buttonDown(Qc.DPAD_UP)?-1:0;e.set(t,n)}return e.lengthSq()>1&&e.normalize(),e}readCameraDelta(e){if(!this.pad)return e.set(0,0);let t=el(this.pad.axes[2]??0,Xc),n=el(this.pad.axes[3]??0,Xc);return e.set(t,n),e}isDashHeld(){if(!this.pad)return!1;let e=this.buttonDown(Qc.A),t=(this.pad.buttons[Qc.RB]?.value??0)>Zc;return e||t}consumeEdges(e){let t=e??{confirm:!1,cancel:!1,toggle:!1,alt:!1,start:!1,prev:!1,next:!1,dpadUp:!1,dpadDown:!1,dpadLeft:!1,dpadRight:!1};if(!this.pad)return t.confirm=t.cancel=t.toggle=t.alt=t.start=!1,t.prev=t.next=!1,t.dpadUp=t.dpadDown=t.dpadLeft=t.dpadRight=!1,t;let n=this.currentButtons(),r=e=>{let t=this.prevButtons[e]===!0,r=n[e]===!0;return!t&&r};return t.confirm=r(Qc.A),t.cancel=r(Qc.B),t.toggle=r(Qc.Y),t.alt=r(Qc.X),t.start=r(Qc.START),t.prev=r(Qc.LB),t.next=r(Qc.RB),t.dpadUp=r(Qc.DPAD_UP),t.dpadDown=r(Qc.DPAD_DOWN),t.dpadLeft=r(Qc.DPAD_LEFT),t.dpadRight=r(Qc.DPAD_RIGHT),this.prevButtons=n,t}pokeConfirm(){this.pad||=this.createFakePad(),this.prevButtons=this.currentButtons().map(()=>!1);let e=this.pad.buttons.map(()=>({pressed:!1,touched:!1,value:0}));e[Qc.A]={pressed:!0,touched:!0,value:1},this.pad={...this.pad,buttons:e},this.prevButtons=e.map(()=>!1)}dispose(){window.removeEventListener(`gamepadconnected`,this.handleConnect),window.removeEventListener(`gamepaddisconnected`,this.handleDisconnect),this.stateListeners.clear(),this.pad=null}handleConnect=e=>{this.pad||this.adopt(e.gamepad)};handleDisconnect=e=>{!this.pad||this.pad.index!==e.gamepad.index||(this.pad=null,this.prevButtons=[],this.updateStatus({connected:!1,index:null,id:null,mapping:null,lastActivity:performance.now()}))};tryAdoptExisting(){let e=navigator.getGamepads?navigator.getGamepads():[];for(let t of e)if(t){this.adopt(t);return}}adopt(e){this.pad=e,this.prevButtons=this.currentButtons(),this.updateStatus({connected:!0,index:e.index,id:e.id,mapping:e.mapping,lastActivity:performance.now()})}updateStatus(e){this.status=e;for(let t of this.stateListeners)t(e)}poll(){if(this.pad){let e=navigator.getGamepads?.()[this.pad.index]??null;if(!e){this.handleDisconnect(new GamepadEvent(`gamepaddisconnected`,{gamepad:this.pad}));return}this.pad=e,this.hasAnyInput()&&(this.status={...this.status,lastActivity:performance.now()})}else this.tryAdoptExisting()}hasAnyInput(){return this.pad?this.pad.axes.some(e=>Math.abs(e)>Xc)?!0:this.currentButtons().some(e=>e):!1}currentButtons(){return this.pad?this.pad.buttons.map(e=>e?.pressed===!0||(e?.value??0)>.5):[]}buttonDown(e){if(!this.pad)return!1;let t=this.pad.buttons[e];return t?t.pressed===!0||(t.value??0)>.5:!1}createFakePad(){let e=Array.from({length:16},()=>({pressed:!1,touched:!1,value:0}));return{id:`virtual-gamepad`,index:999,mapping:`standard`,connected:!0,timestamp:performance.now(),axes:[0,0,0,0],buttons:e,vibrationActuator:null}}};function el(e,t){let n=Math.abs(e);if(n<t)return 0;let r=(n-t)/(1-t);return Math.sign(e)*Math.min(r,1)}var tl=class{update;render;frameId=0;lastTime=0;running=!1;constructor(e,t){this.update=e,this.render=t}start(){this.running||(this.running=!0,this.lastTime=performance.now(),this.frameId=requestAnimationFrame(this.tick))}stop(){this.running=!1,cancelAnimationFrame(this.frameId)}tick=e=>{if(!this.running)return;let t=Math.min((e-this.lastTime)/1e3,.05);this.lastTime=e,this.update(t,e/1e3),this.render(),this.frameId=requestAnimationFrame(this.tick)}};function nl(e){let t=new Jc({canvas:e,antialias:!0,alpha:!1,powerPreference:`high-performance`});return t.outputColorSpace=Le,t.toneMapping=4,t.toneMappingExposure=1.05,t.shadowMap.enabled=!0,t.shadowMap.type=1,t}function rl(e,t,n=2){let r=e.domElement,i=Math.max(1,Math.floor(r.clientWidth)),a=Math.max(1,Math.floor(r.clientHeight)),o=Math.min(window.devicePixelRatio||1,n),s=Math.floor(i*o),c=Math.floor(a*o),l=r.width!==s||r.height!==c;return l&&(e.setPixelRatio(o),e.setSize(i,a,!1),t.aspect=i/a,t.updateProjectionMatrix()),l}function il(e){switch(e){case`火`:return`fire`;case`水`:return`water`;case`木`:return`wood`;case`日`:return`sun`;case`月`:return`moon`;case`山`:return`mountain`;case`人`:return`person`;case`口`:return`mouth`;case`大`:return`big`;case`小`:return`small`;case`天`:return`sky`;case`中`:return`center`;default:return`sparkle`}}var al=class{group=new Tn;type;disposables=[];particles=[];constructor(e,t){this.type=t,this.build(),e.add(this.group)}build(){switch(this.type){case`fire`:this.buildFire();break;case`water`:this.buildWater();break;case`wood`:this.buildWood();break;case`sun`:this.buildSun();break;case`moon`:this.buildMoon();break;case`mountain`:this.buildMountain();break;case`person`:this.buildPerson();break;case`mouth`:this.buildMouth();break;case`big`:this.buildBig();break;case`small`:this.buildSmall();break;case`sky`:this.buildSky();break;case`center`:this.buildCenter();break;case`sparkle`:this.buildSparkle();break}}update(e,t){for(let e of this.particles)e.tick(t)}dispose(){for(let e of this.disposables)e.dispose();this.disposables.length=0,this.particles.length=0,this.group.parent?.remove(this.group),this.group.clear()}track(e){return this.disposables.push(e),e}makeBasic(e,t={}){return this.track(new zr({color:e,transparent:!0,opacity:.95,depthWrite:!1,...t}))}makeStandard(e,t={}){return this.track(new Mi({color:e,transparent:!0,opacity:.95,depthWrite:!1,emissive:new K(e),emissiveIntensity:.6,roughness:.6,metalness:0,...t}))}buildFire(){let e=this.makeBasic(`#ff8a3d`,{opacity:.85}),t=this.makeBasic(`#ffe066`,{opacity:.95}),n=this.track(new gi(.13,.32,6));for(let[r,i]of[[-.7,.2],[.7,.2],[-.55,-.45],[.55,-.45],[-0,.55],[0,-.55]]){let a=new q(n,e);a.position.set(r,-.1,i),this.group.add(a);let o=new q(n,t);o.position.set(r,-.05,i),o.scale.setScalar(.6),this.group.add(o);let s=-.1,c=(r+i)*1.7;this.particles.push({mesh:a,tick:e=>{let t=.9+Math.sin(e*5+c)*.18;a.scale.set(t,t*(1+Math.sin(e*6+c)*.2),t),a.position.y=s+Math.sin(e*4+c)*.08,a.rotation.y=e*1.4+c}}),this.particles.push({mesh:o,tick:e=>{o.scale.setScalar(.55+Math.sin(e*5+c+1)*.12),o.position.y=s+.05+Math.sin(e*4+c+1)*.08}})}}buildWater(){let e=this.makeBasic(`#3aa5d9`,{opacity:.9}),t=this.track(new Y(.08,8,6));for(let n=0;n<6;n+=1){let r=new q(t,e),i=n/6;this.particles.push({mesh:r,tick:e=>{let t=(e*.9+i)%1,n=1.3-t*2,a=Math.sin(i*6.28+e*.7)*.7,o=Math.cos(i*6.28+e*.7)*.4-.3;r.position.set(a,n,o);let s=1-Math.max(0,1-t-.85)*6;r.scale.set(1,Math.max(.3,s),1),r.material.opacity=.9-Math.max(0,t-.85)*4}}),this.group.add(r)}}buildWood(){let e=this.makeStandard(`#5fc36a`,{opacity:1}),t=this.track(new hi(.18,6)),n=this.makeStandard(`#7b4a2a`,{opacity:1}),r=new q(this.track(new J(.025,.03,.5,5)),n);r.position.set(0,.85,0),this.group.add(r);let i=[[.18,.95,0],[-.18,.95,0],[0,1.05,.18],[0,1.05,-.18]];for(let n=0;n<i.length;n+=1){let[r,a,o]=i[n],s=new q(t,e);s.position.set(r,a,o),s.rotation.z=(n-1.5)*.6,s.rotation.x=(n%2==0?1:-1)*.3,this.group.add(s);let c=n*1.3;this.particles.push({mesh:s,tick:e=>{s.rotation.z=(n-1.5)*.6+Math.sin(e*1.4+c)*.15}})}}buildSun(){let e=this.makeBasic(`#ffe066`,{opacity:.55}),t=new q(this.track(new hi(.85,24)),e);t.position.set(0,0,-.65),t.lookAt(0,0,5),this.group.add(t);let n=this.makeBasic(`#ffd23d`,{opacity:.85}),r=this.track(new yi(.12,.28));for(let e=0;e<8;e+=1){let t=new q(r,n),i=e/8*Math.PI*2;t.position.set(Math.cos(i)*1.05,Math.sin(i)*1.05,-.65),t.rotation.z=i-Math.PI/2,t.lookAt(0,0,5),this.group.add(t);let a=e*.7;this.particles.push({mesh:t,tick:e=>{let n=1+Math.sin(e*3+a)*.25;t.scale.set(n,n,1),t.material.opacity=.6+Math.sin(e*3+a)*.3}})}}buildMoon(){let e=this.makeBasic(`#e8f0ff`,{opacity:.5}),t=new q(this.track(new hi(.95,28)),e);t.position.set(0,0,-.7),t.lookAt(0,0,5),this.group.add(t);let n=this.makeBasic(`#ffffff`,{opacity:.9}),r=this.track(new Y(.05,6,6)),i=[[1.1,.6],[-1.05,.4],[.9,-.55],[-.95,-.45]];for(let e=0;e<i.length;e+=1){let t=new q(r,n),[a,o]=i[e];t.position.set(a,o,-.5),this.group.add(t);let s=e*1.1;this.particles.push({mesh:t,tick:e=>{let n=.6+(Math.sin(e*2+s)*.5+.5)*.8;t.scale.setScalar(n),t.material.opacity=.5+(Math.sin(e*2+s)*.5+.5)*.5}})}}buildMountain(){let e=this.makeStandard(`#5fa86b`,{opacity:1}),t=this.track(new gi(.55,.7,4)),n=[[-.7,-.55,.4,1],[.7,-.55,.4,1.05],[0,-.55,-.65,.85]];for(let r=0;r<n.length;r+=1){let[i,a,o,s]=n[r],c=new q(t,e);c.position.set(i,a,o),c.scale.setScalar(s),c.rotation.y=Math.PI/4,this.group.add(c)}}buildPerson(){let e=this.makeBasic(`#a07050`,{opacity:.85}),t=this.track(new hi(.13,12));for(let[n,r,i]of[[-.35,-.65,.95],[.35,-.65,.95]]){let a=new q(t,e);a.position.set(n,r,i),a.rotation.x=-Math.PI/2,a.scale.set(.7,1.1,1),this.group.add(a)}let n=this.track(new hi(.04,8));for(let t=0;t<2;t+=1){let r=t===0?-1:1;for(let t=0;t<3;t+=1){let i=new q(n,e);i.position.set(r*.35,-.7+t*.04,1.15+t*.04),i.rotation.x=-Math.PI/2,this.group.add(i)}}}buildMouth(){let e=this.makeBasic(`#ffffff`,{opacity:0}),t=this.track(new bi(.45,.55,28));for(let n=0;n<3;n+=1){let r=new q(t,e.clone());r.position.set(0,1.05,0),r.rotation.x=-Math.PI/2,this.group.add(r);let i=n/3;this.particles.push({mesh:r,tick:e=>{let t=(e*.7+i)%1;r.scale.setScalar(.6+t*1.6),r.material.opacity=(1-t)*.7}})}}buildBig(){let e=this.makeBasic(`#ffd23d`,{opacity:.55}),t=new q(this.track(new bi(.7,.78,36)),e);t.rotation.x=-Math.PI/2,t.position.y=0,this.group.add(t);let n=this.makeBasic(`#ffd23d`,{opacity:.4}),r=new q(this.track(new bi(1,1.06,36)),n);r.rotation.x=-Math.PI/2,r.position.y=0,this.group.add(r),this.particles.push({mesh:r,tick:e=>{r.rotation.z=e*.6}});let i=this.makeBasic(`#ffe066`,{opacity:1}),a=this.track(new vi(.09,0)),o=[[-.25,1.15],[.25,1.15],[0,1.35]];for(let e=0;e<o.length;e+=1){let[t,n]=o[e],r=new q(a,i);r.position.set(t,n,0),this.group.add(r);let s=e*1.7;this.particles.push({mesh:r,tick:e=>{r.rotation.y=e*2+s,r.scale.setScalar(.9+Math.sin(e*3+s)*.2)}})}}buildSmall(){let e=this.makeBasic(`#3a3a3a`,{opacity:.9}),t=new q(this.track(new bi(.13,.18,18)),e);t.position.set(.55,1,.5),this.group.add(t);let n=this.makeBasic(`#cfeaff`,{opacity:.4}),r=new q(this.track(new hi(.16,18)),n);r.position.set(.55,1,.5),this.group.add(r);let i=this.makeBasic(`#3a3a3a`,{opacity:.9}),a=new q(this.track(new J(.035,.035,.3,6)),i);a.position.set(.78,.78,.73),a.rotation.z=Math.PI/4,this.group.add(a);let o=this.makeBasic(`#8c6cd9`,{opacity:.8}),s=this.track(new Y(.035,6,6));for(let e=0;e<4;e+=1){let t=new q(s,o),n=e/4;this.group.add(t),this.particles.push({mesh:t,tick:e=>{let r=(e*.6+n)%1;t.position.set(Math.cos(n*6.28+e*.5)*.85,1.25-r*.4,Math.sin(n*6.28+e*.5)*.85);let i=.6+(1-r)*.6;t.scale.setScalar(i)}})}}buildSky(){let e=this.makeStandard(`#ffffff`,{opacity:.95,emissive:new K(`#ffffff`),emissiveIntensity:.2}),t=this.track(new Y(.22,12,8)),n=[[-.5,1.4,0,1],[.55,1.55,-.1,.85]];for(let r=0;r<n.length;r+=1){let[i,a,o,s]=n[r],c=new Tn;c.position.set(i,a,o),c.scale.setScalar(s);for(let[n,r,i]of[[0,0,0],[.18,.04,.04],[-.16,.05,-.02],[.05,.1,0]]){let a=new q(t,e);a.position.set(n,r,i),a.scale.setScalar(.7),c.add(a)}this.group.add(c);let l=r*1.3;this.particles.push({mesh:c,tick:e=>{c.position.x=i+Math.sin(e*.5+l)*.08}})}}buildCenter(){let e=this.makeBasic(`#ffffff`,{opacity:.8}),t=this.track(new yi(.06,1.6)),n=[[0,0,.78,0],[0,0,-.78,0],[.78,0,0,Math.PI/2],[-.78,0,0,Math.PI/2]];for(let r=0;r<n.length;r+=1){let[i,a,o,s]=n[r],c=new q(t,e);c.position.set(i,a,o),c.rotation.y=s,c.rotation.x=-Math.PI/2,this.group.add(c)}let r=this.makeBasic(`#ffffff`,{opacity:.95}),i=new q(this.track(new hi(.07,16)),r);i.rotation.x=-Math.PI/2,i.position.y=.01,this.group.add(i)}buildSparkle(){let e=this.makeBasic(`#ffffff`,{opacity:1}),t=this.track(new vi(.06,0));for(let n=0;n<8;n+=1){let r=new q(t,e),i=n/8,a=i*Math.PI*2,o=.95,s=Math.cos(a)*o,c=Math.sin(a)*.5+.4,l=Math.sin(a)*o*.6;this.group.add(r),this.particles.push({mesh:r,tick:e=>{let t=.4+(Math.sin(e*2+i*6.28)*.5+.5)*1;r.scale.setScalar(t),r.position.set(s+Math.sin(e*.6+i*6.28)*.15,c+Math.sin(e*1+i*6.28)*.2,l+Math.cos(e*.5+i*6.28)*.15),r.material.opacity=.4+(Math.sin(e*2+i*6.28)*.5+.5)*.6,r.rotation.y=e*1.2+i*6.28}})}}};function ol(e,t={}){let n=t.size??256,r=t.bg??`#fff4d6`,i=t.color??`#ff7a3d`,a=document.createElement(`canvas`);a.width=n,a.height=n;let o=a.getContext(`2d`);if(!o)throw Error(`createBlockFaceTexture: cannot create 2D context`);let s=n*.16;o.fillStyle=r,sl(o,0,0,n,n,s),o.fill(),o.lineWidth=Math.round(n*.018),o.strokeStyle=`rgba(255,255,255,0.85)`,sl(o,n*.06,n*.06,n*.88,n*.88,s*.85),o.stroke(),o.font=`bold ${Math.round(n*.6)}px "PingFang SC","Hiragino Sans GB","Microsoft YaHei","Noto Sans CJK SC","Source Han Sans SC",sans-serif`,o.textAlign=`center`,o.textBaseline=`middle`,o.fillStyle=i,o.fillText(e,n/2,n/2+n*.04);let c=new li(a);return c.colorSpace=Le,c.anisotropy=8,c.needsUpdate=!0,c}function sl(e,t,n,r,i,a){let o=Math.min(a,r/2,i/2);e.beginPath(),e.moveTo(t+o,n),e.lineTo(t+r-o,n),e.quadraticCurveTo(t+r,n,t+r,n+o),e.lineTo(t+r,n+i-o),e.quadraticCurveTo(t+r,n+i,t+r-o,n+i),e.lineTo(t+o,n+i),e.quadraticCurveTo(t,n+i,t,n+i-o),e.lineTo(t,n+o),e.quadraticCurveTo(t,n,t+o,n),e.closePath()}var cl=class{group=new Tn;radius=.95;color;active=!0;glyph;restRotationY;bobPhase;faceMaterials;geometry;mesh;collecting=!1;collectProgress=0;collectStart=new U;collectTarget=new U(0,12,0);rejecting=!1;rejectTimer=0;rejectAnchor=new U;effect=null;constructor(e,t,n,r,i){this.color=n,this.glyph=e,this.restRotationY=r,this.bobPhase=i,this.geometry=new pi(1.1,1.1,1.1,1,1,1);let a=new Mi({map:ol(e,{bg:n.bg,color:n.fg}),roughness:.45,metalness:.05}),o=new Mi({color:new K(n.bg).multiplyScalar(.95),roughness:.5,metalness:.05}),s=new Mi({color:new K(n.bg).multiplyScalar(.85),roughness:.6,metalness:.05});this.faceMaterials=[a,a,o,s,a,a],this.mesh=new q(this.geometry,this.faceMaterials),this.mesh.castShadow=!0,this.mesh.receiveShadow=!0,this.group.add(this.mesh);let c=new q(new bi(.6,.78,36),new zr({color:n.fg,transparent:!0,opacity:.35,side:2,depthWrite:!1}));c.rotation.x=-Math.PI/2,c.position.y=-.5,this.group.add(c),this.group.position.copy(t),this.group.rotation.y=r,this.rejectAnchor.copy(t)}setGlyph(e){if(this.glyph===e)return;this.glyph=e;let t=new Mi({map:ol(e,{bg:this.color.bg,color:this.color.fg}),roughness:.45,metalness:.05}),n=this.faceMaterials[0];this.faceMaterials[0]=t,this.faceMaterials[1]=t,this.faceMaterials[4]=t,this.faceMaterials[5]=t,n&&n!==t&&(n.map&&n.map.dispose(),n.dispose())}update(e,t){if(this.active){if(this.effect?.update(e,t),this.collecting){this.collectProgress=Math.min(1,this.collectProgress+e*1.6);let t=ll(this.collectProgress);this.group.position.lerpVectors(this.collectStart,this.collectTarget,t);let n=Dt.lerp(1,.18,t);this.group.scale.setScalar(n),this.group.rotation.x+=e*6,this.group.rotation.y+=e*8,this.collectProgress>=1&&(this.active=!1,this.group.visible=!1);return}if(this.rejecting){this.rejectTimer-=e;let t=Math.max(0,this.rejectTimer/.45);this.group.position.x=this.rejectAnchor.x+Math.sin(this.rejectTimer*32)*.18*t,this.rejectTimer<=0&&(this.rejecting=!1,this.group.position.copy(this.rejectAnchor))}this.group.position.y=1.05+Math.sin(t*2.2+this.bobPhase)*.18,this.group.rotation.y+=e*.6,this.mesh.rotation.y-=e*.4}}collect(e){this.collecting||(this.collecting=!0,this.collectProgress=0,this.collectStart.copy(this.group.position),this.collectTarget.copy(e))}reject(){this.collecting||this.rejecting||(this.rejecting=!0,this.rejectTimer=.45,this.rejectAnchor.copy(this.group.position))}reset(e,t,n){this.collecting=!1,this.collectProgress=0,this.rejecting=!1,this.rejectTimer=0,this.active=!0,this.group.visible=!0,this.group.scale.setScalar(1),this.group.position.copy(e),this.rejectAnchor.copy(e),this.group.rotation.y=n,this.mesh.rotation.set(0,0,0),this.setGlyph(t),this.disposeEffect(),this.stabilizeVisuals()}setEffect(e){this.disposeEffect(),this.effect=new al(this.group,e)}disposeEffect(){this.effect&&=(this.effect.dispose(),null)}stabilizeVisuals(){this.group.position.y=1.05+Math.sin(this.bobPhase)*.18,this.group.rotation.set(0,this.restRotationY,0),this.mesh.rotation.set(0,0,0)}dispose(){this.disposeEffect(),this.geometry.dispose();for(let e of this.faceMaterials)e.map&&e.map.dispose(),e.dispose();let e=this.group.children[1];e instanceof q&&(e.geometry.dispose(),e.material.dispose())}};function ll(e){let t=1-e;return 1-t*t*t}var ul=`#ffd0e0`,dl=`#ff9bb7`,fl=`#ffc1d6`,pl=class{group=new Tn;velocity=new U;move=new H;targetVelocity=new U;bodyMaterial=new Mi({color:ul,roughness:.55,metalness:.02});earMaterial=new Mi({color:fl,roughness:.5,metalness:.02});innerEarMaterial=new Mi({color:dl,roughness:.6,metalness:0});eyeMaterial=new Mi({color:`#2a2440`,roughness:.3,metalness:.1});cheekMaterial=new zr({color:`#ff8aa8`,transparent:!0,opacity:.55});bodyGeometry=new Y(.42,24,18);headGeometry=new Y(.32,24,18);earGeometry=new mi(.07,.32,6,12);innerEarGeometry=new mi(.035,.26,6,12);eyeGeometry=new Y(.045,12,10);tailGeometry=new Y(.12,16,12);cheekGeometry=new hi(.06,16);leftEar;rightEar;head;body;tail;accessoryGroup=new Tn;currentCostumeId=null;constructor(){this.body=new q(this.bodyGeometry,this.bodyMaterial),this.body.castShadow=!0,this.body.receiveShadow=!0,this.body.position.y=.46,this.body.scale.set(1,.92,1.05),this.group.add(this.body),this.head=new q(this.headGeometry,this.bodyMaterial),this.head.castShadow=!0,this.head.position.set(0,.86,.05),this.group.add(this.head),this.leftEar=new q(this.earGeometry,this.earMaterial),this.leftEar.castShadow=!0,this.leftEar.position.set(-.13,1.18,-.02),this.leftEar.rotation.z=.18,this.group.add(this.leftEar),this.rightEar=new q(this.earGeometry,this.earMaterial),this.rightEar.castShadow=!0,this.rightEar.position.set(.13,1.18,-.02),this.rightEar.rotation.z=-.18,this.group.add(this.rightEar);let e=new q(this.innerEarGeometry,this.innerEarMaterial);e.position.copy(this.leftEar.position),e.rotation.copy(this.leftEar.rotation),e.position.x+=.005,this.group.add(e);let t=new q(this.innerEarGeometry,this.innerEarMaterial);t.position.copy(this.rightEar.position),t.rotation.copy(this.rightEar.rotation),t.position.x-=.005,this.group.add(t);let n=new q(this.eyeGeometry,this.eyeMaterial);n.position.set(-.11,.92,.28),this.group.add(n);let r=new q(this.eyeGeometry,this.eyeMaterial);r.position.set(.11,.92,.28),this.group.add(r);let i=new q(this.cheekGeometry,this.cheekMaterial);i.position.set(-.2,.84,.28),this.group.add(i);let a=new q(this.cheekGeometry,this.cheekMaterial);a.position.set(.2,.84,.28),this.group.add(a),this.tail=new q(this.tailGeometry,this.bodyMaterial),this.tail.castShadow=!0,this.tail.position.set(0,.5,-.42),this.group.add(this.tail),this.group.add(this.accessoryGroup)}update(e,t,n,r,i,a=0){n.readMovement(this.move);let o=this.move.x,s=this.move.y,c=Math.cos(a),l=Math.sin(a),u=o*c+s*l,d=-o*l+s*c;this.targetVelocity.set(u,0,d).multiplyScalar(r.speed);let f=1-Math.exp(-r.acceleration*e);this.velocity.lerp(this.targetVelocity,f),this.group.position.addScaledVector(this.velocity,e),this.group.position.x=Dt.clamp(this.group.position.x,-i.halfWidth+.8,i.halfWidth-.8),this.group.position.z=Dt.clamp(this.group.position.z,-i.halfDepth+.8,i.halfDepth-.8),this.velocity.lengthSq()>.001&&(this.group.rotation.y=Math.atan2(this.velocity.x,this.velocity.z));let p=Math.min(this.velocity.length()/5,1),m=Math.abs(Math.sin(t*11))*.06*p;this.group.position.y=m;let h=Math.sin(t*4)*.05;this.leftEar.rotation.x=h,this.rightEar.rotation.x=-h}reset(){this.group.position.set(0,0,0),this.group.rotation.set(0,0,0),this.velocity.set(0,0,0),this.move.set(0,0),this.targetVelocity.set(0,0,0),this.stabilizeVisuals()}stabilizeVisuals(){this.group.position.y=0,this.leftEar.rotation.x=0,this.rightEar.rotation.x=0}setCostume(e){let t=!e||e.accessory===`none`||e.id===`default`;this.currentCostumeId=e?.id??null,t?(this.bodyMaterial.color.set(ul),this.earMaterial.color.set(fl),this.innerEarMaterial.color.set(dl)):(this.bodyMaterial.color.set(e.primary),this.earMaterial.color.set(e.secondary),this.innerEarMaterial.color.set(e.secondary)),this.clearAccessories(),t||this.buildAccessory(e)}getCurrentCostumeId(){return this.currentCostumeId}clearAccessories(){for(;this.accessoryGroup.children.length>0;){let e=this.accessoryGroup.children[0];this.accessoryGroup.remove(e),this.disposeObject(e)}}disposeObject(e){e.traverse(e=>{let t=e;if(t.isMesh){t.geometry?.dispose?.();let e=t.material;Array.isArray(e)?e.forEach(e=>e.dispose?.()):e&&e.dispose?.()}})}buildAccessory(e){let t=e.accessoryColor;switch(e.accessory){case`bow`:this.buildBow(t);break;case`hat`:this.buildHat(t);break;case`scarf`:this.buildScarf(t);break;case`glasses`:this.buildGlasses(t);break;case`cape`:this.buildCape(t);break;case`leaf`:this.buildLeaf(t);break;case`star`:this.buildStar(t);break;case`rainbow`:this.buildRainbow();break;case`crown`:this.buildCrown(t);break;default:break}}buildBow(e){let t=new Mi({color:e,roughness:.45,metalness:.05}),n=new q(new Y(.06,12,8),t);n.position.set(0,1.24,.05),this.accessoryGroup.add(n);let r=new q(new gi(.13,.22,12),t);r.position.set(-.13,1.24,.05),r.rotation.z=Math.PI/2-.6,this.accessoryGroup.add(r);let i=new q(new gi(.13,.22,12),t);i.position.set(.13,1.24,.05),i.rotation.z=-Math.PI/2+.6,this.accessoryGroup.add(i)}buildHat(e){let t=new Mi({color:e,roughness:.55,metalness:.02}),n=new q(new gi(.22,.34,18),t);n.position.set(0,1.32,.02),n.castShadow=!0,this.accessoryGroup.add(n);let r=new q(new Y(.05,12,8),t);r.position.set(0,1.5,.02),this.accessoryGroup.add(r);let i=new q(new J(.21,.21,.04,24),new Mi({color:`#ff7ab0`,roughness:.5}));i.position.set(0,1.15,.02),this.accessoryGroup.add(i)}buildScarf(e){let t=new Mi({color:e,roughness:.7,metalness:0}),n=new q(new xi(.22,.06,12,24),t);n.position.set(0,.78,0),n.rotation.x=Math.PI/2,this.accessoryGroup.add(n);let r=new q(new pi(.08,.32,.04),t);r.position.set(.16,.6,.1),r.rotation.z=-.18,this.accessoryGroup.add(r)}buildGlasses(e){let t=new Mi({color:e,roughness:.3,metalness:.4}),n=new bi(.06,.085,18),r=new zr({color:`#ffffff`,transparent:!0,opacity:.45}),i=new q(n,r);i.position.set(-.11,.93,.31),this.accessoryGroup.add(i);let a=new q(n,r);a.position.set(.11,.93,.31),this.accessoryGroup.add(a);let o=new q(new pi(.07,.018,.018),t);o.position.set(0,.93,.31),this.accessoryGroup.add(o);let s=new q(new xi(.075,.012,6,18),t);s.position.set(-.11,.93,.31),this.accessoryGroup.add(s);let c=new q(new xi(.075,.012,6,18),t);c.position.set(.11,.93,.31),this.accessoryGroup.add(c)}buildCape(e){let t=new Mi({color:e,roughness:.6,metalness:.05,side:2}),n=new q(new yi(.7,.7,1,3),t);n.position.set(0,.62,-.42),n.rotation.x=.18,n.castShadow=!0,this.accessoryGroup.add(n);let r=new Mi({color:`#ffe1ec`,roughness:.55}),i=new q(new J(.22,.18,.08,18,1,!0),r);i.position.set(0,.85,-.05),this.accessoryGroup.add(i)}buildLeaf(e){let t=new Mi({color:e,roughness:.5,metalness:0}),n=new q(new gi(.07,.22,10),t);n.position.set(-.04,1.26,.04),n.rotation.z=.6,this.accessoryGroup.add(n);let r=new q(new gi(.07,.22,10),t);r.position.set(.04,1.26,.04),r.rotation.z=-.6,this.accessoryGroup.add(r);let i=new q(new J(.012,.012,.08,6),new Mi({color:`#4a8a2c`}));i.position.set(0,1.2,.05),this.accessoryGroup.add(i)}buildStar(e){let t=new Mi({color:e,roughness:.35,metalness:.3,emissive:e,emissiveIntensity:.25}),n=new q(new vi(.1,0),t);n.position.set(0,1.32,.06),n.scale.set(1,1.2,.6),n.castShadow=!0,this.accessoryGroup.add(n);for(let e=0;e<3;e+=1){let n=new q(new Y(.025,10,8),t),r=e/3*Math.PI*2+Math.PI/6;n.position.set(Math.cos(r)*.16,1.36+Math.sin(r)*.05,.04),this.accessoryGroup.add(n)}}buildRainbow(){let e=[`#ff7ab0`,`#ffb347`,`#ffe066`,`#74e1c0`,`#5fb1f5`,`#c8b6f8`];e.forEach((t,n)=>{let r=new Mi({color:t,roughness:.5,metalness:.05}),i=new q(new Y(.04,12,8),r),a=n/e.length*Math.PI*2-Math.PI/2;i.position.set(Math.cos(a)*.18,1.24,.04+Math.sin(a)*.12),this.accessoryGroup.add(i)});for(let t=0;t<7;t+=1){let n=e[t%e.length],r=new Mi({color:n,roughness:.4,metalness:.1}),i=new q(new Y(.035,10,8),r),a=t/7*Math.PI-Math.PI/2;i.position.set(Math.cos(a)*.22,.78+Math.sin(a)*.1,0),this.accessoryGroup.add(i)}}buildCrown(e){let t=new Mi({color:e,roughness:.3,metalness:.55,emissive:`#ff9a3d`,emissiveIntensity:.12}),n=new q(new J(.22,.22,.1,24,1,!0),t);n.position.set(0,1.22,.02),this.accessoryGroup.add(n);for(let e=0;e<5;e+=1){let n=new q(new gi(.04,.12,8),t),r=e/5*Math.PI*2-Math.PI/2;n.position.set(Math.cos(r)*.22,1.34,.02+Math.sin(r)*.22),this.accessoryGroup.add(n);let i=[`#ff7ab0`,`#5fb1f5`,`#74e1c0`,`#ffe066`,`#c8b6f8`][e]??`#ffffff`,a=new q(new Y(.035,10,8),new Mi({color:i,roughness:.2,metalness:.4}));a.position.set(Math.cos(r)*.22,1.28,.02+Math.sin(r)*.22),this.accessoryGroup.add(a)}let r=new q(new Y(.05,12,10),new Mi({color:`#ff5a8a`,roughness:.15,metalness:.5,emissive:`#ff5a8a`,emissiveIntensity:.18}));r.position.set(0,1.22,.24),this.accessoryGroup.add(r)}dispose(){this.bodyGeometry.dispose(),this.headGeometry.dispose(),this.earGeometry.dispose(),this.innerEarGeometry.dispose(),this.eyeGeometry.dispose(),this.tailGeometry.dispose(),this.cheekGeometry.dispose(),this.bodyMaterial.dispose(),this.earMaterial.dispose(),this.innerEarMaterial.dispose(),this.eyeMaterial.dispose(),this.cheekMaterial.dispose(),this.clearAccessories()}},ml=class{context=null;unlocked=!1;constructor(){let e=()=>{this.unlock(),window.removeEventListener(`pointerdown`,e),window.removeEventListener(`keydown`,e)};window.addEventListener(`pointerdown`,e,{once:!0}),window.addEventListener(`keydown`,e,{once:!0})}async unlock(){if(this.unlocked)return;let e=window.AudioContext||window.webkitAudioContext;e&&(this.context=new e,await this.context.resume(),this.unlocked=!0)}correct(){this.playArpeggio([523.25,659.25,783.99],.09,`sine`,.16)}wrong(){this.playTone(180,.18,`square`,.05)}word(){this.playArpeggio([523.25,659.25,783.99,1046.5],.08,`triangle`,.18)}allDone(){if(!this.context||this.context.state!==`running`)return;let e=this.context.currentTime;[523.25,659.25,783.99,1046.5,1318.5].forEach((t,n)=>{let r=this.context.createOscillator(),i=this.context.createGain();r.type=`triangle`,r.frequency.setValueAtTime(t,e+n*.12),i.gain.setValueAtTime(1e-4,e+n*.12),i.gain.exponentialRampToValueAtTime(.18,e+n*.12+.03),i.gain.exponentialRampToValueAtTime(1e-4,e+n*.12+.42),r.connect(i).connect(this.context.destination),r.start(e+n*.12),r.stop(e+n*.12+.5)})}dispose(){this.context?.close(),this.context=null}playArpeggio(e,t,n,r){if(!this.context||this.context.state!==`running`)return;let i=this.context.currentTime;e.forEach((e,a)=>{let o=this.context.createOscillator(),s=this.context.createGain();o.type=n,o.frequency.setValueAtTime(e,i+a*t),s.gain.setValueAtTime(1e-4,i+a*t),s.gain.exponentialRampToValueAtTime(r,i+a*t+.02),s.gain.exponentialRampToValueAtTime(1e-4,i+a*t+t*1.4),o.connect(s).connect(this.context.destination),o.start(i+a*t),o.stop(i+a*t+t*1.6)})}playTone(e,t,n,r){if(!this.context||this.context.state!==`running`)return;let i=this.context.currentTime,a=this.context.createOscillator(),o=this.context.createGain();a.type=n,a.frequency.setValueAtTime(e,i),a.frequency.exponentialRampToValueAtTime(e*.7,i+t),o.gain.setValueAtTime(1e-4,i),o.gain.exponentialRampToValueAtTime(r,i+.01),o.gain.exponentialRampToValueAtTime(1e-4,i+t),a.connect(o).connect(this.context.destination),a.start(i),a.stop(i+t+.02)}},hl=class{camera;yaw=0;pitch=.55;radius;desiredPosition=new U;lookTarget=new U;constructor(e,t=13.5){this.camera=e,this.radius=t}getYaw(){return this.yaw}getPitch(){return this.pitch}rotate(e,t){this.yaw-=e,this.pitch=Dt.clamp(this.pitch+t,.18,1.15)}setAngles(e,t){this.yaw=e,this.pitch=Dt.clamp(t,.18,1.15)}snapTo(e){this.computeDesiredPosition(e),this.camera.position.copy(this.desiredPosition),this.lookTarget.copy(e).add(new U(0,.4,0)),this.camera.lookAt(this.lookTarget)}update(e,t,n){this.computeDesiredPosition(t);let r=1-Math.exp(-e/Math.max(.001,n));this.camera.position.lerp(this.desiredPosition,r),this.lookTarget.copy(t).add(new U(0,.4,0)),this.camera.lookAt(this.lookTarget)}computeDesiredPosition(e){let t=this.radius*Math.cos(this.pitch),n=this.radius*Math.sin(this.pitch);this.desiredPosition.set(e.x+Math.sin(this.yaw)*t,e.y+n+1.2,e.z+Math.cos(this.yaw)*t)}},gl=class{delta=new U;collectTargets(e,t,n){let r=[];for(let i of n){if(!i.active)continue;this.delta.copy(e).sub(i.group.position),this.delta.y=0;let n=t+i.radius;this.delta.lengthSq()<=n*n&&r.push(i)}return r}},_l=[{id:`default`,name:`小白兔`,unlock:0,primary:`#ffd0e0`,secondary:`#ffc1d6`,accessory:`none`,accessoryColor:`#ffffff`},{id:`pink-bow`,name:`粉红蝴蝶结`,unlock:10,primary:`#ffd0e0`,secondary:`#ff8fb8`,accessory:`bow`,accessoryColor:`#ff7ab0`},{id:`yellow-hat`,name:`黄色小帽`,unlock:20,primary:`#fff0d0`,secondary:`#ffd96b`,accessory:`hat`,accessoryColor:`#ffc845`},{id:`blue-scarf`,name:`蓝色围巾`,unlock:30,primary:`#dfeefc`,secondary:`#a8d5ff`,accessory:`scarf`,accessoryColor:`#5fb1f5`},{id:`purple-glasses`,name:`紫色眼镜`,unlock:40,primary:`#ece4ff`,secondary:`#c8b6f8`,accessory:`glasses`,accessoryColor:`#8c6cd9`},{id:`red-cape`,name:`红色披风`,unlock:50,primary:`#ffd9d9`,secondary:`#ff8a8a`,accessory:`cape`,accessoryColor:`#e94f4f`},{id:`green-leaf`,name:`绿叶头饰`,unlock:60,primary:`#dff5d4`,secondary:`#a6e287`,accessory:`leaf`,accessoryColor:`#5fbf42`},{id:`orange-star`,name:`橙色星星`,unlock:70,primary:`#ffe6c2`,secondary:`#ffc06b`,accessory:`star`,accessoryColor:`#ff9a3d`},{id:`rainbow`,name:`彩虹礼服`,unlock:80,primary:`#ffe0f0`,secondary:`#c7e8ff`,accessory:`rainbow`,accessoryColor:`#ff7ab0`},{id:`golden`,name:`金色公主`,unlock:95,primary:`#fff4cc`,secondary:`#ffd770`,accessory:`crown`,accessoryColor:`#ffc23d`}];function vl(e){if(!e||typeof e!=`object`)return!1;let t=e;return typeof t.id==`string`&&typeof t.name==`string`&&typeof t.unlock==`number`&&typeof t.primary==`string`&&typeof t.secondary==`string`&&typeof t.accessory==`string`&&typeof t.accessoryColor==`string`}function yl(e){let t;if(Array.isArray(e))t=e;else if(e&&typeof e==`object`&&Array.isArray(e.costumes))t=e.costumes;else return _l;let n=t.filter(vl);return n.length>0?n:_l}var bl=null;function xl(){return bl?Promise.resolve(bl):fetch(`/costumes.json`).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.json()}).then(e=>yl(e)).catch(()=>_l).then(e=>(bl=e,e))}function Sl(e,t){if(t){let n=e.find(e=>e.id===t);if(n)return n}return e.find(e=>e.unlock===0)??e[0]}var Cl=`literacy-town.selectedCostumeId`;function wl(){if(typeof window>`u`)return null;try{let e=window.localStorage.getItem(Cl);return e&&e.length>0?e:null}catch{return null}}function Tl(e){if(!(typeof window>`u`))try{e&&e.length>0?window.localStorage.setItem(Cl,e):window.localStorage.removeItem(Cl)}catch{}}function El(e){switch(e){case`bow`:return`🎀`;case`hat`:return`🎩`;case`scarf`:return`🧣`;case`glasses`:return`👓`;case`cape`:return`🧥`;case`leaf`:return`🍃`;case`star`:return`⭐`;case`rainbow`:return`🌈`;case`crown`:return`👑`;default:return`🐰`}}var Dl={meadow:`🌳`,farm:`🐄`,castle:`🏰`,town:`🏘️`,orchard:`🍎`,rainbow:`🌈`,ocean:`🐠`,sakura:`🌸`,snow:`❄️`,beach:`🏖️`,iceberg:`🧊`,space:`🚀`,wheatfield:`🌾`,palace:`🏯`,garden:`🌷`,bazaar:`🛍️`,theater:`🎭`,workshop:`🔨`,kitchen:`🍳`,skyGarden:`☁️`};function Ol(e){return e?Dl[e]??`🗺️`:`🗺️`}var kl=class{promptPicture=this.getElement(`#prompt-picture`);promptPinyin=this.getElement(`#prompt-pinyin`);promptCard=this.getElement(`#prompt-card`);promptWordSlots=this.collectWordSlots();roundDots=this.getElement(`#round-dots`);statusLine=this.getElement(`#status-line`);overlay=this.getElement(`#overlay`);overlayTitle=this.getElement(`#overlay-title`);overlayBody=this.getElement(`#overlay-body`);overlayExtras=this.getElement(`#overlay-extras`);overlayButton=this.getElement(`#overlay-button`);overlaySecondary=this.getElement(`#overlay-secondary`);mobileHint=this.getElement(`#mobile-hint`);mobileHintClose=this.getElement(`#mobile-hint-close`);gamepadHint=this.getElement(`#gamepad-hint`);gamepadHintClose=this.getElement(`#gamepad-hint-close`);outfitFab=this.getElement(`#outfit-fab`);backFab=this.getElement(`#back-fab`);dotElements=[];onStart=()=>{};onRestart=()=>{};onHintDismiss=()=>{};onGamepadHintDismiss=()=>{};onPromptTap=()=>{};onStageSelect=()=>{};onNextStage=()=>{};onBackToList=()=>{};onCostumeSelect=()=>{};onOutfitBack=()=>{};onOutfitFab=()=>{};onBackFab=()=>{};focusables=[];focusIndex=0;focusContext=null;gamepadConnected=!1;constructor(e){this.roundDots.innerHTML=``;for(let t=0;t<e;t+=1){let e=document.createElement(`span`);e.className=`round-dot`,this.roundDots.appendChild(e),this.dotElements.push(e)}this.overlayButton.addEventListener(`click`,()=>{let e=this.overlayButton.dataset.mode;e===`restart`?this.onRestart():e===`next`?this.onNextStage():e===`back`?this.onBackToList():e===`outfit-back`?this.onOutfitBack():this.onStart()}),this.overlaySecondary.addEventListener(`click`,()=>{this.onBackToList()}),this.mobileHintClose.addEventListener(`click`,()=>{this.hideMobileHint(),this.onHintDismiss()}),this.gamepadHintClose.addEventListener(`click`,()=>{this.hideGamepadHint(),this.onGamepadHintDismiss()});let t=0;this.promptCard.addEventListener(`pointerdown`,e=>{e.preventDefault();let n=performance.now();n-t<350||(t=n,this.onPromptTap())}),this.outfitFab.addEventListener(`click`,()=>this.onOutfitFab()),this.backFab.addEventListener(`click`,()=>this.onBackFab())}bindStart(e){this.onStart=e}bindRestart(e){this.onRestart=e}bindHintDismiss(e){this.onHintDismiss=e}bindGamepadHintDismiss(e){this.onGamepadHintDismiss=e}bindPromptTap(e){this.onPromptTap=e}bindStageSelect(e){this.onStageSelect=e}bindNextStage(e){this.onNextStage=e}bindBackToList(e){this.onBackToList=e}bindCostumeSelect(e){this.onCostumeSelect=e}bindOutfitBack(e){this.onOutfitBack=e}bindOutfitFab(e){this.onOutfitFab=e}bindBackFab(e){this.onBackFab=e}setOutfitFabVisible(e){this.outfitFab.hidden=!e}setBackFabVisible(e){this.backFab.hidden=!e}showMobileHint(){this.mobileHint.classList.add(`hint-visible`)}hideMobileHint(){this.mobileHint.classList.remove(`hint-visible`)}showGamepadHint(){this.gamepadHint.classList.add(`hint-visible`)}hideGamepadHint(){this.gamepadHint.classList.remove(`hint-visible`)}setGamepadConnected(e){this.gamepadConnected=e,this.outfitFab.classList.toggle(`gp-active`,e)}refreshFocusables(){if(!this.overlay.classList.contains(`overlay-visible`)){let e=[];this.backFab.hidden||e.push(this.backFab),this.outfitFab.hidden||e.push(this.outfitFab),this.focusContext=e.length===0?null:`playing`,this.focusables=e,this.focusIndex=0,this.renderFocus();return}if(this.overlay.classList.contains(`outfit`)){this.focusContext=`outfit`;let e=Array.from(this.overlayExtras.querySelectorAll(`.outfit-card.unlocked`)),t=[this.overlayButton,...e].filter(e=>!!e);this.focusables=t;let n=t.findIndex(e=>e.classList.contains(`selected`));this.focusIndex=n>=0?n:+(t.length>1),this.renderFocus();return}if(this.overlay.classList.contains(`celebrate`)){this.focusContext=`celebration`;let e=[];this.overlayButton.hidden||e.push(this.overlayButton),this.overlaySecondary.hidden||e.push(this.overlaySecondary),this.focusables=e,this.focusIndex=0,this.renderFocus();return}this.focusContext=`level-select`;let e=Array.from(this.overlayExtras.querySelectorAll(`.stage-card`)),t=this.overlayExtras.querySelector(`.outfit-entry`),n=[...e];t&&n.push(t),this.focusables=n;let r=n.findIndex(e=>e.classList.contains(`last-played`));this.focusIndex=r>=0?r:0,this.renderFocus()}renderFocus(){for(let e of this.focusables)e.classList.remove(`gp-focus`);let e=this.focusables[this.focusIndex];e&&(e.classList.add(`gp-focus`),e.scrollIntoView({block:`nearest`,inline:`nearest`}))}focusStepColumn(e){this.focusables.length!==0&&(this.focusIndex=(this.focusIndex+e+this.focusables.length)%this.focusables.length,this.renderFocus())}applyGamepadEdges(e){if(!this.gamepadConnected||this.focusables.length===0&&(this.refreshFocusables(),this.focusables.length===0))return;let t=!1;switch(this.focusContext){case`level-select`:case`outfit`:e.dpadLeft?(this.focusIndex=Math.max(0,this.focusIndex-1),t=!0):e.dpadRight&&(this.focusIndex=Math.min(this.focusables.length-1,this.focusIndex+1),t=!0),this.focusContext,e.dpadUp?(this.focusIndex=Math.max(0,this.focusIndex-2),t=!0):e.dpadDown&&(this.focusIndex=Math.min(this.focusables.length-1,this.focusIndex+2),t=!0);break;default:e.dpadLeft||e.dpadUp?(this.focusIndex=Math.max(0,this.focusIndex-1),t=!0):(e.dpadRight||e.dpadDown)&&(this.focusIndex=Math.min(this.focusables.length-1,this.focusIndex+1),t=!0);break}t&&this.renderFocus(),e.confirm&&this.activateFocused(),e.cancel&&this.activateCancel()}activateFocused(){let e=this.focusables[this.focusIndex];e&&!e.hidden&&(e.click(),e.classList.add(`gp-pulse`),window.setTimeout(()=>e.classList.remove(`gp-pulse`),220))}activateCancel(){this.focusContext===`outfit`?this.onOutfitBack():this.focusContext===`celebration`&&this.onBackToList()}showLevelSelect(e,t,n=-1){this.overlay.classList.add(`overlay-visible`),this.overlay.classList.remove(`celebrate`,`outfit`),this.overlayTitle.textContent=`识字小镇`,this.overlayBody.textContent=`选一关开始学习吧～已学会的会有标记。`,this.overlayExtras.replaceChildren();let r=document.createElement(`button`);r.type=`button`,r.className=`outfit-entry`,r.innerHTML=`<span class="outfit-entry-icon">👗</span> 换装`,r.addEventListener(`click`,()=>this.onOutfitFab()),this.overlayExtras.appendChild(r);let i=document.createElement(`div`);i.className=`stage-grid`;let a=e.length>0?Math.max(0,Math.min(n,e.length-1)):-1;e.forEach((e,n)=>{let r=t.has(n),o=n===a,s=document.createElement(`button`);s.type=`button`,s.className=`stage-card unlocked`,r&&s.classList.add(`done`),o&&s.classList.add(`last-played`);let c=document.createElement(`div`);c.className=`stage-icon`,c.textContent=e.icon;let l=document.createElement(`div`);l.className=`stage-title`,l.textContent=e.title;let u=document.createElement(`div`);u.className=`stage-subtitle`,u.textContent=e.subtitle;let d=document.createElement(`div`);if(d.className=`stage-status`,d.textContent=r?`✅ 已学会`:`▶ 开始学习`,s.append(c,l,u,d),e.themeName){let t=document.createElement(`div`);t.className=`stage-theme theme-${e.theme??`default`}`;let n=document.createElement(`span`);n.className=`stage-theme-icon`,n.textContent=Ol(e.theme);let r=document.createElement(`span`);r.className=`stage-theme-text`;let i=e.themeSubtitle?` · ${e.themeSubtitle}`:``;r.textContent=`${e.themeName}${i}`,t.append(n,r),s.appendChild(t)}if(o){let e=document.createElement(`div`);e.className=`stage-badge`,e.textContent=`上次玩到这`,s.appendChild(e)}s.addEventListener(`click`,()=>this.onStageSelect(n)),i.appendChild(s)}),this.overlayExtras.appendChild(i),this.overlayButton.hidden=!0,this.overlayButton.textContent=``,delete this.overlayButton.dataset.mode,this.overlaySecondary.hidden=!0,this.overlaySecondary.textContent=``,this.refreshFocusables(),requestAnimationFrame(()=>{let e=i.querySelector(`.stage-card.last-played`);e&&e.scrollIntoView({behavior:`smooth`,block:`center`})})}hideOverlay(){this.overlay.classList.remove(`overlay-visible`,`outfit`,`celebrate`),this.overlayExtras.replaceChildren(),this.overlayButton.hidden=!1,this.overlaySecondary.hidden=!0,this.refreshFocusables()}showOutfitPicker(e,t,n,r=`← 返回关卡`){this.overlay.classList.add(`overlay-visible`,`outfit`),this.overlay.classList.remove(`celebrate`),this.overlayTitle.textContent=`👗 挑一套衣服`,this.overlayBody.textContent=`已学会 ${n} 关，解锁更多衣服吧～`,this.overlayExtras.replaceChildren();let i=document.createElement(`div`);i.className=`outfit-grid`,e.slice().sort((e,t)=>e.unlock-t.unlock).forEach(e=>{let r=e.unlock<=n,a=r&&e.id===t,o=document.createElement(`button`);o.type=`button`,o.className=r?`outfit-card unlocked`:`outfit-card locked`,a&&o.classList.add(`selected`);let s=document.createElement(`div`);s.className=`outfit-color`,s.style.background=`linear-gradient(135deg, ${e.primary}, ${e.secondary})`;let c=document.createElement(`div`);c.className=`outfit-emoji`,c.textContent=El(e.accessory);let l=document.createElement(`div`);l.className=`outfit-name`,l.textContent=e.name;let u=document.createElement(`div`);u.className=`outfit-status`,r?u.textContent=a?`✅ 当前穿着`:`点击穿上`:u.textContent=`🔒 再学 ${Math.max(0,e.unlock-n)} 关解锁`,o.append(s,c,l,u),r?o.addEventListener(`click`,()=>this.onCostumeSelect(e.id)):o.addEventListener(`click`,()=>{u.animate([{transform:`translateX(0)`},{transform:`translateX(-4px)`},{transform:`translateX(4px)`},{transform:`translateX(0)`}],{duration:240})}),i.appendChild(o)}),this.overlayExtras.appendChild(i),this.overlayButton.hidden=!1,this.overlayButton.textContent=r,this.overlayButton.dataset.mode=`outfit-back`,this.overlaySecondary.hidden=!0,this.overlaySecondary.textContent=``,this.refreshFocusables()}showCelebration(e){let{words:t,hasNextStage:n,nextStageTitle:r,unlockedCostumeName:i}=e;if(this.overlay.classList.add(`overlay-visible`,`celebrate`),this.overlay.classList.remove(`outfit`),this.overlayTitle.textContent=`🎉 你学会啦！`,this.overlayBody.innerHTML=`今天学到的字：<br><strong style="display:inline-block;font-size:24px;color:#ff7a3d;letter-spacing:0.18em;line-height:1.6;margin-top:4px;">`+t.map(e=>`<span style="white-space:nowrap;">${e}</span>`).join(` · `)+`</strong>`,this.overlayExtras.replaceChildren(),i){let e=document.createElement(`div`);e.className=`unlock-note`,e.innerHTML=`🎁 解锁新衣服：<strong>${i}</strong>！`,this.overlayExtras.appendChild(e)}this.overlayButton.hidden=!1,this.overlayButton.textContent=n?`下一关：${r??``}`.trim():`回到关卡列表`,this.overlayButton.dataset.mode=n?`next`:`back`,this.overlaySecondary.hidden=!1,this.overlaySecondary.textContent=`选择其他关卡`,this.refreshFocusables()}setRound(e,t,n){this.promptPicture.textContent=e.picture,this.promptPinyin.textContent=e.pinyin,this.promptWordSlots.forEach(e=>{e.classList.remove(`char-filled`),e.textContent=`?`});for(let e=0;e<this.dotElements.length;e+=1){let n=this.dotElements[e];n.classList.remove(`dot-active`,`dot-done`),e<t?n.classList.add(`dot-done`):e===t&&n.classList.add(`dot-active`)}this.setStatus(`第 ${t+1} / ${n} 关 · 走向正确的汉字`)}fillCharSlot(e,t){let n=this.promptWordSlots[e];n&&(n.textContent=t,n.classList.add(`char-filled`))}flashPrompt(){this.promptCard.classList.remove(`prompt-tapped`),this.promptCard.offsetWidth,this.promptCard.classList.add(`prompt-tapped`)}setStatus(e,t=!1){this.statusLine.textContent=e,t&&(this.statusLine.classList.remove(`flash`),this.statusLine.offsetWidth,this.statusLine.classList.add(`flash`))}setWrongHint(e){this.setStatus(`“${e}” 不对哦，再试试 ✨`,!0)}setCorrectHint(e){this.setStatus(`太棒了！“${e}” 找到啦 ✨`,!0)}setRoundComplete(e){this.setStatus(`完成词语 · ${e} 🎉`,!0)}markRoundDone(e){let t=this.dotElements[e];t&&(t.classList.remove(`dot-active`),t.classList.add(`dot-done`))}getElement(e){let t=document.querySelector(e);if(!t)throw Error(`Missing HUD element: ${e}`);return t}collectWordSlots(){let e=document.querySelectorAll(`#prompt-word .char-slot`),t=[];return e.forEach(e=>{e instanceof HTMLElement&&t.push(e)}),t}},Al=class{unlocked=!1;voice=null;available=!1;constructor(){if(typeof window>`u`||!(`speechSynthesis`in window))return;this.available=!0;let e=()=>{this.unlock(),window.removeEventListener(`pointerdown`,e),window.removeEventListener(`keydown`,e)};window.addEventListener(`pointerdown`,e,{once:!0}),window.addEventListener(`keydown`,e,{once:!0}),window.speechSynthesis.onvoiceschanged!==void 0&&(window.speechSynthesis.onvoiceschanged=()=>this.refreshVoice()),this.refreshVoice()}async unlock(){if(!(!this.available||this.unlocked)){this.unlocked=!0;try{let e=new SpeechSynthesisUtterance(` `);e.volume=0,window.speechSynthesis.speak(e)}catch{}this.refreshVoice()}}refreshVoice(){if(!this.available)return;let e=window.speechSynthesis.getVoices(),t=e.find(e=>/zh[-_]CN/i.test(e.lang)&&/female|child|tingting|yaoyao|meijia/i.test(e.name))||e.find(e=>/zh[-_]CN/i.test(e.lang))||e.find(e=>/zh/i.test(e.lang))||e[0]||null;this.voice=t}speakGlyph(e,t={}){if(this.available)try{window.speechSynthesis.cancel();let n=new SpeechSynthesisUtterance(e);n.lang=`zh-CN`,n.rate=t.rate??.85,n.pitch=t.pitch??1.05,this.voice&&(n.voice=this.voice),window.speechSynthesis.speak(n)}catch{}}speakWord(e){if(this.available)try{window.speechSynthesis.cancel();let t=new SpeechSynthesisUtterance(e);t.lang=`zh-CN`,t.rate=.8,t.pitch=1.05,this.voice&&(t.voice=this.voice),window.speechSynthesis.speak(t)}catch{}}announceRound(e){if(this.available)try{window.speechSynthesis.cancel();let t=`${e.word}`,n=new SpeechSynthesisUtterance(t);n.lang=`zh-CN`,n.rate=.8,n.pitch=1.05,this.voice&&(n.voice=this.voice),window.speechSynthesis.speak(n)}catch{}}speakCelebration(e){if(!(!this.available||e.length===0))try{window.speechSynthesis.cancel();let t=new SpeechSynthesisUtterance(`太棒了！你学会了：${e.join(`、`)}`);t.lang=`zh-CN`,t.rate=.85,t.pitch=1.1,this.voice&&(t.voice=this.voice),window.speechSynthesis.speak(t)}catch{}}cancel(){if(this.available)try{window.speechSynthesis.cancel()}catch{}}dispose(){this.cancel()}isAvailable(){return this.available}},jl=class{canvas;onRotate;onDragStart=()=>{};onDragEnd=()=>{};activePointerId=null;lastX=0;lastY=0;sensitivity=.006;pitchSensitivity=.004;disabled=!1;constructor(e,t,n={}){this.canvas=e,this.onRotate=t,n.onDragStart&&(this.onDragStart=n.onDragStart),n.onDragEnd&&(this.onDragEnd=n.onDragEnd),this.canvas.addEventListener(`pointerdown`,this.onPointerDown),this.canvas.addEventListener(`pointermove`,this.onPointerMove),this.canvas.addEventListener(`pointerup`,this.onPointerUp),this.canvas.addEventListener(`pointercancel`,this.onPointerUp)}setDisabled(e){this.disabled=e,e&&this.activePointerId!==null&&(this.activePointerId=null,this.onDragEnd())}dispose(){this.canvas.removeEventListener(`pointerdown`,this.onPointerDown),this.canvas.removeEventListener(`pointermove`,this.onPointerMove),this.canvas.removeEventListener(`pointerup`,this.onPointerUp),this.canvas.removeEventListener(`pointercancel`,this.onPointerUp)}onPointerDown=e=>{this.disabled||e.pointerType===`mouse`&&e.button!==0||this.activePointerId===null&&(this.activePointerId=e.pointerId,this.lastX=e.clientX,this.lastY=e.clientY,this.onDragStart())};onPointerMove=e=>{if(this.activePointerId!==e.pointerId)return;let t=e.clientX-this.lastX,n=e.clientY-this.lastY;this.lastX=e.clientX,this.lastY=e.clientY,this.onRotate(t*this.sensitivity,n*this.pitchSensitivity)};onPointerUp=e=>{this.activePointerId===e.pointerId&&(this.activePointerId=null,this.onDragEnd())}};function Ml(e){let t=e>>>0;return()=>{t=t+1831565813>>>0;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}function Nl(e){let t=e.rng??Ml(1),n=e.maxAttempts??80,r=[],i=e.minDistanceFromPlayer,a=e.minDistanceBetweenCubes;for(let o=0;o<e.cubeCount;o+=1){let o=null;for(let s=0;s<n;s+=1){let n=Pl(t,e.spawn);if(!(n.distanceTo(e.playerPosition)<i)&&!r.some(e=>n.distanceTo(e.position)<a)){o=n;break}}if(!o)for(let i=0;i<n;i+=1){let n=Pl(t,e.spawn);if(!r.some(e=>n.distanceTo(e.position)<a)){o=n;break}}o||=Pl(t,e.spawn),r.push({position:new U(o.x,1.1,o.z),rotationY:t()*Math.PI*2,bobPhase:t()*Math.PI*2}),a=Math.max(1.4,a*.85)}return r}function Pl(e,t){return new U(t.minX+e()*(t.maxX-t.minX),1.1,t.minZ+e()*(t.maxZ-t.minZ))}var Fl=[{id:`basics`,title:`第一关`,subtitle:`基础笔画`,icon:`一`,rounds:[{picture:`1️⃣`,pinyin:`yī`,word:`一`,correctIndex:0,choices:[`一`,`二`,`三`]},{picture:`2️⃣`,pinyin:`èr`,word:`二`,correctIndex:1,choices:[`三`,`二`,`一`]},{picture:`3️⃣`,pinyin:`sān`,word:`三`,correctIndex:2,choices:[`一`,`三`,`二`]},{picture:`➕`,pinyin:`shí`,word:`十`,correctIndex:0,choices:[`十`,`八`,`人`]},{picture:`🧒`,pinyin:`rén`,word:`人`,correctIndex:1,choices:[`入`,`人`,`八`]}]},{id:`directions`,title:`第二关`,subtitle:`方位大小`,icon:`大`,rounds:[{picture:`⬆️`,pinyin:`shàng`,word:`上`,correctIndex:0,choices:[`上`,`下`,`大`]},{picture:`⬇️`,pinyin:`xià`,word:`下`,correctIndex:1,choices:[`大`,`下`,`小`]},{picture:`🦏`,pinyin:`dà`,word:`大`,correctIndex:2,choices:[`小`,`上`,`大`]},{picture:`🐜`,pinyin:`xiǎo`,word:`小`,correctIndex:0,choices:[`小`,`大`,`下`]},{picture:`⛅`,pinyin:`tiān`,word:`天`,correctIndex:2,choices:[`上`,`大`,`天`]}]},{id:`nature`,title:`第三关`,subtitle:`自然现象`,icon:`日`,rounds:[{picture:`☀️`,pinyin:`rì`,word:`日`,correctIndex:0,choices:[`日`,`月`,`山`]},{picture:`🌙`,pinyin:`yuè`,word:`月`,correctIndex:1,choices:[`山`,`月`,`水`]},{picture:`⛰️`,pinyin:`shān`,word:`山`,correctIndex:2,choices:[`水`,`火`,`山`]},{picture:`🔥`,pinyin:`huǒ`,word:`火`,correctIndex:0,choices:[`火`,`水`,`日`]},{picture:`💧`,pinyin:`shuǐ`,word:`水`,correctIndex:1,choices:[`月`,`水`,`火`]}]},{id:`things`,title:`第四关`,subtitle:`身边的事物`,icon:`木`,rounds:[{picture:`🌳`,pinyin:`mù`,word:`木`,correctIndex:0,choices:[`木`,`本`,`林`]},{picture:`👀`,pinyin:`mù`,word:`目`,correctIndex:1,choices:[`日`,`目`,`木`]},{picture:`👂`,pinyin:`ěr`,word:`耳`,correctIndex:2,choices:[`手`,`月`,`耳`]},{picture:`✋`,pinyin:`shǒu`,word:`手`,correctIndex:0,choices:[`手`,`足`,`目`]},{picture:`👄`,pinyin:`kǒu`,word:`口`,correctIndex:1,choices:[`日`,`口`,`目`]}]}];function Il(e){if(!e||typeof e!=`object`)return!1;let t=e;return typeof t.picture==`string`&&typeof t.pinyin==`string`&&typeof t.word==`string`&&typeof t.correctIndex==`number`&&Array.isArray(t.choices)&&t.choices.every(e=>typeof e==`string`)&&t.correctIndex>=0&&t.correctIndex<t.choices.length}function Ll(e){if(!e||typeof e!=`object`)return!1;let t=e;return typeof t.id==`string`&&typeof t.title==`string`&&typeof t.subtitle==`string`&&typeof t.icon==`string`&&Array.isArray(t.rounds)&&t.rounds.length>0&&t.rounds.every(Il)&&(t.theme===void 0||typeof t.theme==`string`)&&(t.themeName===void 0||typeof t.themeName==`string`)&&(t.themeSubtitle===void 0||typeof t.themeSubtitle==`string`)}function Rl(e){let t;if(Array.isArray(e))t=e;else if(e&&typeof e==`object`&&Array.isArray(e.stages))t=e.stages;else return Fl;let n=t.filter(Ll);return n.length>0?n:Fl}var zl=null;function Bl(){return zl?Promise.resolve(zl):fetch(`/stages.json`).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.json()}).then(e=>Rl(e)).catch(()=>Fl).then(e=>(zl=e,e))}function Vl(){if(typeof window>`u`)return new Set;try{let e=window.localStorage.getItem(`literacy-town.completedStages`);if(!e)return new Set;let t=JSON.parse(e);return Array.isArray(t)?new Set(t.filter(e=>typeof e==`number`)):new Set}catch{return new Set}}function Hl(e){if(!(typeof window>`u`))try{window.localStorage.setItem(`literacy-town.completedStages`,JSON.stringify([...e]))}catch{}}var Ul=`literacy-town.lastStageIndex`;function Wl(e=0){if(typeof window>`u`)return e;try{let t=window.localStorage.getItem(Ul);if(!t)return e;let n=parseInt(t,10);return Number.isFinite(n)&&n>=0?n:e}catch{return e}}function Gl(e){if(!(typeof window>`u`))try{window.localStorage.setItem(Ul,String(e))}catch{}}function Q(e,t,n){return t+(n-t)*e()}function Kl(e){let t=Math.floor(e()*4);return t===0?[Q(e,-12,12),-10+Q(e,-.4,.4)]:t===1?[Q(e,-12,12),10+Q(e,-.4,.4)]:t===2?[-12+Q(e,-.4,.4),Q(e,-10,10)]:[12+Q(e,-.4,.4),Q(e,-10,10)]}function ql(e){let t=e()*Math.PI*2,n=Q(e,18,22);return[Math.cos(t)*n,Math.sin(t)*n]}function $(e,t={}){return new Mi({color:e,roughness:t.roughness??.7,metalness:t.metalness??.05,emissive:t.emissive??`#000000`,emissiveIntensity:t.emissiveIntensity??0,transparent:t.transparent??!1,opacity:t.opacity??1,side:t.side??0})}function Jl(e,t,n,r){let i=r.scale??1,a=(r.trunkH??1.1)*i,o=(r.trunkR??.14)*i,s=new q(new J(o,o*1.2,a,8),$(r.trunkColor??`#6e4a2c`,{roughness:.95}));s.position.set(t,a/2,n),s.castShadow=!0,e.add(s);let c=(r.leafR??.7)*i,l;l=r.leafShape===`cone`?new q(new gi(c,c*2.2,14),$(r.leafColor,{roughness:.85,emissive:r.leafEmissive??`#000000`,emissiveIntensity:r.leafEmissive?.18:0})):r.leafShape===`rounded`?new q(new Y(c,14,10),$(r.leafColor,{roughness:.8})):new q(new Y(c,14,12),$(r.leafColor,{roughness:.8,emissive:r.leafEmissive??`#000000`,emissiveIntensity:r.leafEmissive?.18:0})),l.position.set(t,a+c*.85,n),l.castShadow=!0,e.add(l)}function Yl(e,t,n,r=`#cfcfd5`,i=1){let a=new q(new Y(.32*i,10,8),$(r,{roughness:.95}));a.position.set(t,.18*i,n),a.scale.set(1,.6,1),a.castShadow=!0,a.receiveShadow=!0,e.add(a)}function Xl(e,t,n,r){let i=new q(new J(.06,.08,2.4,8),$(r.poleColor??`#5a4a3a`,{roughness:.7,metalness:.3}));i.position.set(t,1.2,n),i.castShadow=!0,e.add(i);let a=new q(new Y(.18,14,10),$(r.lightColor,{emissive:r.lightColor,emissiveIntensity:r.lightEmissiveIntensity??.6,roughness:.4}));a.position.set(t,2.5,n),e.add(a)}function Zl(e,t,n,r=`#efe8d8`){let i=new q(new J(.22,.26,3,16),$(r,{roughness:.6}));i.position.set(t,1.5,n),i.castShadow=!0,e.add(i);let a=new q(new pi(.7,.18,.7),$(r,{roughness:.6}));a.position.set(t,3.1,n),e.add(a);let o=new q(new pi(.7,.18,.7),$(r,{roughness:.6}));o.position.set(t,.09,n),e.add(o)}function Ql(e,t,n,r,i=1){let a=new Mi({color:`#ffffff`,roughness:1,emissive:`#ffffff`,emissiveIntensity:.18}),o=new Tn;for(let e of[{x:0,y:0,z:0,r:1},{x:.9,y:.05,z:0,r:.85},{x:-.85,y:-.02,z:0,r:.78},{x:.4,y:.45,z:0,r:.6}]){let t=new q(new Y(e.r,12,10),a);t.position.set(e.x,e.y,e.z),o.add(t)}o.position.set(t,n,r),o.scale.setScalar(i),e.add(o)}function $l(e,t,n,r=1){let i=new q(new J(.015,.02,1.2*r,6),$(`#c8a850`,{roughness:.8}));i.position.set(t,.6*r,n),e.add(i);let a=new q(new gi(.08*r,.32*r,8),$(`#ffd66b`,{roughness:.6,emissive:`#ffd66b`,emissiveIntensity:.18}));a.position.set(t,1.32*r,n),e.add(a)}function eu(e,t,n,r,i=`#ffffff`){let a=new q(new Y(.05,6,6),new zr({color:i,transparent:!0,opacity:.95}));a.position.set(t,n,r),e.add(a)}var tu=[{id:`meadow`,name:`阳光草地`,subtitle:`自然起步`,icon:`🌳`,skyColor:`#cfeaff`,fogNear:22,fogFar:48,ambientSky:`#fff7d6`,ambientGround:`#a8d8ff`,ambientIntensity:1.6,sunColor:`#fff1bf`,sunIntensity:2.2,sunPosition:[-6,11,7],groundColor:`#9be37a`,groundAccent:`#ffe066`,railColor:`#ffe1ec`,cubePalette:[{bg:`#fff4d6`,fg:`#ff7a3d`},{bg:`#dff3ff`,fg:`#3aa5d9`},{bg:`#f0e4ff`,fg:`#8c6cd9`}],buildDecorations(e,t){Ql(e,-8,7,-4,1),Ql(e,4,8,-6,.8),Ql(e,-3,9,5,1.2),Ql(e,7,7.5,4,.9);let n=[[-14,-14,8,.55],[12,-16,9,.65],[-16,12,10,.7],[14,14,8,.5],[0,-18,12,.85]],r=$(`#74c97c`,{roughness:.9}),i=new zr({color:`#9be37a`});for(let[t,a,o,s]of n){let n=new q(new Y(o,18,12,0,Math.PI*2,0,Math.PI/2),r);n.position.set(t,0,a),n.scale.set(1,s,1),e.add(n);let c=new q(new bi(o*.95,o*1.05,36),i);c.rotation.x=-Math.PI/2,c.position.set(t,.01,a),e.add(c)}for(let n=0;n<4;n+=1){let[n,r]=Kl(t);Jl(e,n,r,{trunkColor:`#7a5532`,leafColor:`#74c97c`,leafShape:`sphere`,scale:.9})}let a=[`#ff7eb9`,`#ffb347`,`#c8b6f8`,`#ffd66b`,`#ffffff`];for(let n=0;n<18;n+=1){let[n,r]=Kl(t),i=a[Math.floor(t()*a.length)]??`#ffb347`,o=new q(new J(.025,.025,.35,4),$(`#5fa84a`,{roughness:.7}));o.position.set(n,.18,r),e.add(o);let s=new q(new Y(.1,8,6),$(i,{roughness:.6}));s.position.set(n,.4,r),e.add(s)}let o=[`#ff7eb9`,`#ffb347`,`#c8b6f8`,`#5fb1f5`];for(let n=0;n<4;n+=1){let[n,r]=Kl(t),i=o[Math.floor(t()*o.length)]??`#ff7eb9`,a=new q(new hi(.15,6),$(i,{roughness:.5,side:2}));a.position.set(n+.08,3+t()*.4,r),a.rotation.y=.3,e.add(a);let s=a.clone();s.position.set(n-.08,3+t()*.4,r),s.rotation.y=-.3,e.add(s)}}},{id:`farm`,name:`农场牧场`,subtitle:`身边万物`,icon:`🐄`,skyColor:`#fde6c2`,fogNear:22,fogFar:50,ambientSky:`#fff2cf`,ambientGround:`#caa76a`,ambientIntensity:1.55,sunColor:`#ffd089`,sunIntensity:2.4,sunPosition:[-7,10,8],groundColor:`#caa76a`,groundAccent:`#8a6a3a`,railColor:`#e9d9b3`,cubePalette:[{bg:`#fff4cc`,fg:`#a8721c`},{bg:`#f6e0d0`,fg:`#b94a3a`},{bg:`#f0f7d4`,fg:`#6c9444`}],buildDecorations(e,t){let n=$(`#8a6a3a`,{roughness:.95}),r=new J(.08,.08,1,6),i=new pi(2.4,.08,.08);for(let a=0;a<4;a+=1){let[a,o]=Kl(t),s=(t()-.5)*.6,c=(t()-.5)*.6;for(let t=-1;t<=1;t+=1){let i=new q(r,n);i.position.set(a+s+t*1,.5,o+c),e.add(i)}for(let t=0;t<2;t+=1){let r=new q(i,n);r.position.set(a+s,.32+t*.4,o+c),e.add(r)}}for(let n=0;n<3;n+=1){let[n,r]=Kl(t),i=new q(new J(.6,.7,1,14),$(`#f0c46a`,{roughness:.95}));i.position.set(n,.5,r),e.add(i);let a=new q(new Y(.6,14,10,0,Math.PI*2,0,Math.PI/2),$(`#f0c46a`,{roughness:.95}));a.position.set(n,1,r),e.add(a)}let a=$(`#7eb27a`,{roughness:.95});for(let n=0;n<3;n+=1){let n=new q(new Y(Q(t,5,8),14,10,0,Math.PI*2,0,Math.PI/2),a),[r,i]=ql(t);n.position.set(r,0,i),n.scale.set(1,Q(t,.4,.7),1),e.add(n)}}},{id:`castle`,name:`童话城堡`,subtitle:`学习智慧`,icon:`🏰`,skyColor:`#b8d5ff`,fogNear:24,fogFar:50,ambientSky:`#e0eaff`,ambientGround:`#9aa5b8`,ambientIntensity:1.45,sunColor:`#ffe9c2`,sunIntensity:2,sunPosition:[-5,12,6],groundColor:`#a8a39a`,groundAccent:`#7a7770`,railColor:`#d6cbb8`,cubePalette:[{bg:`#ffe7d4`,fg:`#d04a8a`},{bg:`#e1e8ff`,fg:`#5577c8`},{bg:`#fff4d4`,fg:`#c89a3a`}],buildDecorations(e,t){for(let[t,n]of[[-13,-10],[13,-10],[-13,10],[13,10]]){let r=new q(new J(.9,1,3.4,16),$(`#dcd6c8`,{roughness:.7}));r.position.set(t,1.7,n),r.castShadow=!0,e.add(r);let i=new q(new gi(1,1.6,16),$(`#c14a4a`,{roughness:.7}));i.position.set(t,4,n),e.add(i);let a=new q(new pi(.32,.18,.04),$(`#ffd66b`,{emissive:`#ffd66b`,emissiveIntensity:.3}));a.position.set(t+.4,4.9,n),e.add(a);let o=new q(new J(.025,.025,.5,6),$(`#5a4a3a`,{roughness:.6}));o.position.set(t+.4,4.7,n),e.add(o)}for(let n=0;n<2;n+=1){let n=new q(new Y(Q(t,5,7),16,10,0,Math.PI*2,0,Math.PI/2),$(`#7c8a9e`,{roughness:.9})),[r,i]=ql(t);n.position.set(r,0,i),n.scale.set(1,Q(t,.6,.9),1),e.add(n)}for(let n=0;n<6;n+=1){let[n,r]=Kl(t);Jl(e,n,r,{trunkColor:`#5a3a2a`,leafColor:`#3a7a4a`,leafShape:`cone`,scale:Q(t,.8,1.1)})}Ql(e,-10,9,2,.9),Ql(e,11,8.5,-3,.8),Ql(e,-4,10,-8,.7),Ql(e,7,9.5,7,.8)}},{id:`town`,name:`小镇广场`,subtitle:`生活日常`,icon:`🏘️`,skyColor:`#cfeaff`,fogNear:22,fogFar:48,ambientSky:`#fff4d6`,ambientGround:`#b59c80`,ambientIntensity:1.5,sunColor:`#ffe6b8`,sunIntensity:2.1,sunPosition:[-5,11,7],groundColor:`#b59c80`,groundAccent:`#8a6f54`,railColor:`#7a5a4a`,cubePalette:[{bg:`#ffe7d4`,fg:`#cc6a3a`},{bg:`#dff0e4`,fg:`#5a9a6a`},{bg:`#fff4d4`,fg:`#c8a04a`}],buildDecorations(e,t){for(let[t,n]of[[-12,-6],[12,-6],[-12,6],[12,6]])Xl(e,t,n,{poleColor:`#3a2a1a`,lightColor:`#ffd66b`});for(let[t,n]of[[-11,0],[11,0]]){let r=new q(new xi(.8,.16,8,18),$(`#7a5a4a`,{roughness:.8}));r.rotation.x=Math.PI/2,r.position.set(t,.16,n),e.add(r);for(let r=0;r<5;r+=1){let i=r/5*Math.PI*2,a=new q(new Y(.12,8,6),$([`#ff7ab0`,`#ffd66b`,`#ff5a5a`,`#c8b6f8`,`#74e1c0`][r]??`#ffffff`,{emissive:`#000000`}));a.position.set(t+Math.cos(i)*.55,.32,n+Math.sin(i)*.55),e.add(a)}}Jl(e,-13,8,{trunkColor:`#6a4a30`,leafColor:`#74c97c`,leafShape:`rounded`,scale:.8}),Jl(e,13,8,{trunkColor:`#6a4a30`,leafColor:`#74c97c`,leafShape:`rounded`,scale:.8})}},{id:`orchard`,name:`丰收果园`,subtitle:`食物厨房`,icon:`🍎`,skyColor:`#ffe0c8`,fogNear:22,fogFar:48,ambientSky:`#fff0d6`,ambientGround:`#a87a5a`,ambientIntensity:1.55,sunColor:`#ffcb88`,sunIntensity:2.3,sunPosition:[-7,11,6],groundColor:`#b87a5a`,groundAccent:`#ff5a5a`,railColor:`#7a4a30`,cubePalette:[{bg:`#ffe7d4`,fg:`#d04a4a`},{bg:`#fff4cc`,fg:`#d8a230`},{bg:`#fbe0e6`,fg:`#cc6a8a`}],buildDecorations(e,t){let n=[`#ff5a5a`,`#ffd66b`,`#ff8aa8`,`#ff5a5a`,`#ffd66b`,`#ff8aa8`],r=[`#7eb27a`,`#8ac97c`,`#a3c97c`,`#7eb27a`,`#8ac97c`,`#a3c97c`];for(let i=0;i<6;i+=1){let[a,o]=Kl(t);Jl(e,a,o,{trunkColor:`#6a4a30`,leafColor:r[i]??`#7eb27a`,leafShape:`rounded`,scale:1.1});for(let r=0;r<3;r+=1){let s=new q(new Y(.13,10,8),$(n[i]??`#ff5a5a`,{emissive:n[i]??`#ff5a5a`,emissiveIntensity:.15,roughness:.4})),c=r/3*Math.PI*2;s.position.set(a+Math.cos(c)*.45,1.8645+(t()-.5)*.3,o+Math.sin(c)*.45),e.add(s)}}}},{id:`rainbow`,name:`彩虹乐园`,subtitle:`感官形状`,icon:`🌈`,skyColor:`#d4e9ff`,fogNear:22,fogFar:48,ambientSky:`#fff0fa`,ambientGround:`#e0d4ff`,ambientIntensity:1.7,sunColor:`#ffffff`,sunIntensity:2,sunPosition:[-5,11,7],groundColor:`#d6f0e0`,groundAccent:`#ff7ab0`,railColor:`#ffffff`,cubePalette:[{bg:`#ffe7d4`,fg:`#ff5a8a`},{bg:`#fff4cc`,fg:`#ffb347`},{bg:`#e0f7ff`,fg:`#5fb1f5`}],buildDecorations(e,t){let n=[`#ff5a8a`,`#ffb347`,`#ffe066`,`#74e1c0`,`#5fb1f5`,`#c8b6f8`];for(let t=0;t<n.length;t+=1){let r=new q(new xi(4-t*.25,.15,8,28,Math.PI),$(n[t]??`#ffffff`,{roughness:.4,emissive:n[t]??`#ffffff`,emissiveIntensity:.25}));r.position.set(0,.3,-14),r.rotation.x=0,r.rotation.z=0,r.rotation.y=Math.PI/2,e.add(r)}Ql(e,-10,8,-3,.9),Ql(e,10,8,-3,.9);for(let r=0;r<5;r+=1){let i=new q(new Y(.32,12,10),$(n[r]??`#ff5a8a`,{roughness:.5})),[a,o]=Kl(t);i.position.set(a,5+t()*1.5,o),e.add(i);let s=new q(new J(.01,.01,2.5,4),$(`#888888`,{roughness:.8}));s.position.set(a,5+t()*1.5-1.5,o),e.add(s)}}},{id:`ocean`,name:`海底世界`,subtitle:`动物植物`,icon:`🐠`,skyColor:`#2a6a9a`,fogNear:16,fogFar:40,ambientSky:`#88c4e8`,ambientGround:`#1a4a6a`,ambientIntensity:1.4,sunColor:`#cae8ff`,sunIntensity:1.6,sunPosition:[0,14,-2],groundColor:`#d4be85`,groundAccent:`#f0e6c0`,railColor:`#3a8aaa`,cubePalette:[{bg:`#d4f0ff`,fg:`#2a8ad0`},{bg:`#ffe7d4`,fg:`#ff8a4a`},{bg:`#f7e7ff`,fg:`#9a5ad0`}],buildDecorations(e,t){let n=new Mi({color:`#3aa5d9`,transparent:!0,opacity:.45,metalness:0,roughness:.1}),r=new q(new yi(28,28),n);r.rotation.x=-Math.PI/2,r.position.set(0,5.5,0),e.add(r);for(let n=0;n<18;n+=1){let n=new q(new Y(Q(t,.08,.22),8,6),new Mi({color:`#ffffff`,transparent:!0,opacity:.7,roughness:.2,metalness:.4}));n.position.set(Q(t,-13,13),Q(t,.6,5),Q(t,-10,10)),e.add(n)}let i=[`#ff7a8a`,`#ffb347`,`#c8b6f8`,`#ff5a5a`];for(let n=0;n<8;n+=1){let n=new q(new gi(Q(t,.3,.55),Q(t,1,1.8),10),$(i[Math.floor(t()*i.length)]??`#ff7a8a`,{roughness:.7}));n.position.set(Q(t,-14,14),Q(t,.5,1),Q(t,-11,11)),e.add(n)}Yl(e,-13,-9,`#7a8a98`,1.3),Yl(e,13,-9,`#7a8a98`,1.1),Yl(e,13,9,`#7a8a98`,1.2)}},{id:`sakura`,name:`樱花林`,subtitle:`自然地理`,icon:`🌸`,skyColor:`#ffd6e4`,fogNear:20,fogFar:46,ambientSky:`#fff0f4`,ambientGround:`#d4a8b8`,ambientIntensity:1.6,sunColor:`#ffe8d4`,sunIntensity:2.1,sunPosition:[-6,11,7],groundColor:`#d4b89c`,groundAccent:`#ffb1c8`,railColor:`#8a5a6a`,cubePalette:[{bg:`#fff0f4`,fg:`#ff7ab0`},{bg:`#ffe7d4`,fg:`#ff5a8a`},{bg:`#ffe0e8`,fg:`#c84a8a`}],buildDecorations(e,t){for(let n=0;n<12;n+=1){let[n,r]=Kl(t);Jl(e,n,r,{trunkColor:`#6a4a3a`,leafColor:`#ffb1c8`,leafShape:`rounded`,scale:Q(t,.85,1.15),leafEmissive:`#ff8aa8`})}for(let n=0;n<4;n+=1){let[n,r]=ql(t);Jl(e,n,r,{trunkColor:`#6a4a3a`,leafColor:`#ff8aa8`,leafShape:`rounded`,scale:Q(t,1.2,1.6),leafEmissive:`#ff7eb9`})}for(let n=0;n<5;n+=1){let[n,r]=Kl(t),i=new q(new Y(Q(t,.4,.7),10,8),$(`#7eb27a`,{roughness:.85}));i.position.set(n,.3,r),i.scale.y=.7,e.add(i)}let n=$(`#ffb1c8`,{emissive:`#ffb1c8`,emissiveIntensity:.25,roughness:.5});for(let r=0;r<16;r+=1){let r=new q(new hi(.18,8),n);r.rotation.x=-Math.PI/2,r.position.set(Q(t,-12,12),.02,Q(t,-10,10)),e.add(r)}}},{id:`snow`,name:`雪地冬景`,subtitle:`时间动作`,icon:`❄️`,skyColor:`#dceaff`,fogNear:22,fogFar:48,ambientSky:`#ffffff`,ambientGround:`#a0b8d4`,ambientIntensity:1.65,sunColor:`#ffffff`,sunIntensity:2,sunPosition:[-5,11,7],groundColor:`#f4f8ff`,groundAccent:`#ffffff`,railColor:`#c8d4e0`,cubePalette:[{bg:`#ffe7d4`,fg:`#5fb1f5`},{bg:`#dff0ff`,fg:`#3a7ac8`},{bg:`#f7e7ff`,fg:`#8a6cd9`}],buildDecorations(e,t){for(let n=0;n<10;n+=1){let[n,r]=Kl(t);Jl(e,n,r,{trunkColor:`#5a3a2a`,leafColor:`#2a6a3a`,leafShape:`cone`,scale:Q(t,.9,1.2)})}for(let n=0;n<4;n+=1){let[n,r]=ql(t);Yl(e,n,r,`#a8b0bc`,Q(t,.8,1.2))}let n=new q(new Y(.55,14,12),$(`#ffffff`,{roughness:.5}));n.position.set(-13,.55,-8),e.add(n);let r=new q(new Y(.4,14,12),$(`#ffffff`,{roughness:.5}));r.position.set(-13,1.35,-8),e.add(r);let i=new q(new Y(.3,14,12),$(`#ffffff`,{roughness:.5}));i.position.set(-13,1.95,-8),e.add(i);let a=new q(new gi(.08,.32,10),$(`#ff8a4a`,{roughness:.6}));a.position.set(-13,1.95,-7.72),a.rotation.x=Math.PI/2,e.add(a);let o=new q(new J(.32,.32,.32,14),$(`#2a2a3a`,{roughness:.6}));o.position.set(-13,2.25,-8),e.add(o);let s=new q(new J(.42,.42,.05,18),$(`#2a2a3a`,{roughness:.6}));s.position.set(-13,2.05,-8),e.add(s);for(let n=0;n<14;n+=1){let n=new q(new Y(Q(t,.05,.12),6,6),new zr({color:`#ffffff`}));n.position.set(Q(t,-14,14),Q(t,2.6,6),Q(t,-11,11)),e.add(n)}}},{id:`beach`,name:`沙滩海岸`,subtitle:`形容描述`,icon:`🏖️`,skyColor:`#cce8ff`,fogNear:22,fogFar:48,ambientSky:`#fff4d6`,ambientGround:`#caa66a`,ambientIntensity:1.7,sunColor:`#ffe089`,sunIntensity:2.6,sunPosition:[-7,10,6],groundColor:`#f0d896`,groundAccent:`#a8721c`,railColor:`#a87a4a`,cubePalette:[{bg:`#fff4cc`,fg:`#ff7a3d`},{bg:`#d4f0ff`,fg:`#3aa5d9`},{bg:`#ffe7d4`,fg:`#ff5a5a`}],buildDecorations(e,t){for(let n=0;n<3;n+=1){let[n,r]=Kl(t),i=new q(new J(.18,.22,3,8),$(`#7a4a2a`,{roughness:.95}));i.position.set(n,1.5,r),i.rotation.z=(t()-.5)*.3,i.castShadow=!0,e.add(i);for(let t=0;t<3;t+=1){let i=new q(new Y(.18,10,8),$(`#3a2a1a`,{roughness:.8}));i.position.set(n,3+t*.08,r),e.add(i)}for(let t=0;t<6;t+=1){let i=t/6*Math.PI*2,a=new q(new pi(.08,.04,1.4),$(`#5fa84a`,{roughness:.7}));a.position.set(n+Math.cos(i)*.6,3.1,r+Math.sin(i)*.6),a.rotation.y=i,a.rotation.x=-.5,e.add(a)}}let n=new q(new J(.04,.04,2,6),$(`#5a4a3a`,{roughness:.8}));n.position.set(13,1,9),e.add(n);let r=new q(new gi(1.2,.5,14,1,!0),$(`#ff5a5a`,{roughness:.6,side:2}));r.position.set(13,2.2,9),e.add(r);let i=new q(new yi(40,4),new Mi({color:`#3aa5d9`,transparent:!0,opacity:.7,roughness:.1,metalness:.2}));i.rotation.x=-Math.PI/2,i.position.set(0,.02,-13),e.add(i);for(let t=0;t<2;t+=1){let n=t===0?-10:9,r=new q(new pi(1.6,.1,.6),$(`#ffffff`,{roughness:.5}));r.position.set(n,.35,-8),r.castShadow=!0,e.add(r);let i=new q(new pi(1.6,.5,.1),$(`#ffffff`,{roughness:.5}));i.position.set(n,.55,-8.25),i.rotation.x=-.5,e.add(i)}let a=[`#fff4d6`,`#ffd6c8`,`#e8c8a8`,`#ffffff`];for(let n=0;n<14;n+=1){let[n,r]=Kl(t),i=a[Math.floor(t()*a.length)]??`#fff4d6`,o=new q(new Y(Q(t,.12,.22),8,6),$(i,{roughness:.5}));o.position.set(n,.08,r),o.scale.y=.5,e.add(o)}Ql(e,-10,8,-4,1),Ql(e,8,9,-6,.9),Ql(e,-7,9,8,.8),Ql(e,10,7.5,5,.9)}},{id:`iceberg`,name:`极地冰原`,subtitle:`数字量度`,icon:`🧊`,skyColor:`#a8d0e8`,fogNear:22,fogFar:48,ambientSky:`#dceaff`,ambientGround:`#a0c4d8`,ambientIntensity:1.6,sunColor:`#ffffff`,sunIntensity:2,sunPosition:[-5,11,7],groundColor:`#dfeefa`,groundAccent:`#a8d4e8`,railColor:`#a8d4e8`,cubePalette:[{bg:`#e1f0ff`,fg:`#3a7ac8`},{bg:`#dfeefa`,fg:`#5fb1f5`},{bg:`#fff4d4`,fg:`#ff8a4a`}],buildDecorations(e,t){let n=$(`#dfeefa`,{roughness:.3,metalness:.1});for(let r=0;r<8;r+=1){let[r,i]=Kl(t),a=new q(new gi(Q(t,.8,1.6),Q(t,1.5,2.8),8),n);a.position.set(r,Q(t,1,1.8),i),a.castShadow=!0,e.add(a);let o=new q(new gi(.4,.6,8),n);o.position.set(r,a.position.y+1.8,i),e.add(o)}for(let n=0;n<4;n+=1){let[n,r]=ql(t),i=new q(new pi(Q(t,1,1.6),Q(t,.4,.7),Q(t,1,1.6)),$(`#c8e0f0`,{roughness:.4}));i.position.set(n,.25,r),e.add(i)}for(let[t,n]of[[-13,-8],[13,-8],[-13,9],[13,9]]){let r=new q(new Y(.3,12,10),$(`#2a2a3a`,{roughness:.8}));r.position.set(t,.4,n),r.scale.set(1,1.2,.9),e.add(r);let i=new q(new Y(.22,12,10),$(`#ffffff`,{roughness:.6}));i.position.set(t,.38,n+.1),i.scale.set(.8,1,.6),e.add(i);let a=new q(new Y(.18,10,8),$(`#2a2a3a`,{roughness:.8}));a.position.set(t,.85,n),e.add(a)}let r=new q(new yi(20,6),$(`#a8d4e8`,{roughness:.4}));r.position.set(0,3,-15),e.add(r);for(let n=0;n<12;n+=1){let n=new q(new Y(Q(t,.05,.12),6,6),new zr({color:`#ffffff`}));n.position.set(Q(t,-14,14),Q(t,2.6,6),Q(t,-11,11)),e.add(n)}}},{id:`space`,name:`太空探险`,subtitle:`词语法则`,icon:`🚀`,skyColor:`#4a5ad0`,fogNear:26,fogFar:60,ambientSky:`#b0c0ff`,ambientGround:`#3a4070`,ambientIntensity:1.6,sunColor:`#fff8d6`,sunIntensity:2.2,sunPosition:[10,14,-4],groundColor:`#6a70a0`,groundAccent:`#ffffff`,railColor:`#5a6090`,cubePalette:[{bg:`#dfeaff`,fg:`#5577ff`},{bg:`#fff4cc`,fg:`#ffb347`},{bg:`#f7e7ff`,fg:`#9a5ad0`}],buildDecorations(e,t){let n=[`#ffffff`,`#fff4d6`,`#aaccff`,`#ffd066`,`#ffb347`];for(let r=0;r<90;r+=1){let r=t()*Math.PI*2,i=Q(t,18,28);eu(e,Math.cos(r)*i,Q(t,3,12),Math.sin(r)*i,n[Math.floor(t()*n.length)]??`#ffffff`)}let r=new q(new Y(1.6,18,14),$(`#d4a878`,{roughness:.7}));r.position.set(-12,7,-10),e.add(r);let i=new q(new xi(2.4,.18,8,32),$(`#caa6a0`,{roughness:.5}));i.position.set(-12,7,-10),i.rotation.x=.4,e.add(i);let a=new q(new Y(1,16,12),$(`#5fb1f5`,{roughness:.7}));a.position.set(13,8,-12),e.add(a);let o=new Tn,s=new q(new pi(.4,.4,.4),$(`#d4d4d4`,{roughness:.5,metalness:.6}));o.add(s);let c=new q(new pi(1.2,.05,.5),$(`#3050a0`,{roughness:.4,metalness:.5}));c.position.x=.8,o.add(c);let l=c.clone();l.position.x=-.8,o.add(l),o.position.set(-15,10,4),e.add(o);let u=new Tn,d=new q(new J(.35,.35,1.2,14),$(`#ffffff`,{roughness:.4}));d.position.y=0,u.add(d);let f=new q(new gi(.35,.7,14),$(`#ff5a5a`,{roughness:.4}));f.position.y=.95,u.add(f);let p=new q(new gi(.18,.5,8),$(`#ff5a5a`,{roughness:.4}));p.position.set(-.32,-.5,0),p.rotation.z=.6,u.add(p);let m=p.clone();m.position.x=.32,m.rotation.z=-.6,u.add(m),u.position.set(13,3,-8),u.rotation.z=-.2,e.add(u);let h=[`#ff7eb9`,`#5fb1f5`,`#c8b6f8`];for(let t=0;t<3;t+=1){let n=new q(new yi(12,2),new zr({color:h[t]??`#ff7eb9`,transparent:!0,opacity:.18,depthWrite:!1}));n.position.set(-8+t*6,9,-18),e.add(n)}}},{id:`wheatfield`,name:`金色麦田`,subtitle:`连接副词`,icon:`🌾`,skyColor:`#ffe8b8`,fogNear:22,fogFar:48,ambientSky:`#fff4d6`,ambientGround:`#c8a040`,ambientIntensity:1.55,sunColor:`#ffd066`,sunIntensity:2.4,sunPosition:[-7,11,6],groundColor:`#d4a04a`,groundAccent:`#a87832`,railColor:`#a87832`,cubePalette:[{bg:`#fff4cc`,fg:`#d8a230`},{bg:`#ffe7d4`,fg:`#cc6a3a`},{bg:`#fff8d4`,fg:`#a87832`}],buildDecorations(e,t){for(let n=0;n<12;n+=1){let[n,r]=Kl(t);$l(e,n,r,Q(t,.85,1.15))}let n=$(`#caa66a`,{roughness:.95});for(let r=0;r<2;r+=1){let r=new q(new Y(Q(t,5,8),16,10,0,Math.PI*2,0,Math.PI/2),n),[i,a]=ql(t);r.position.set(i,0,a),r.scale.set(1,Q(t,.4,.7),1),e.add(r)}}},{id:`palace`,name:`古代宫殿`,subtitle:`建设职业`,icon:`🏯`,skyColor:`#e8d4a8`,fogNear:24,fogFar:50,ambientSky:`#fff0d6`,ambientGround:`#b89c70`,ambientIntensity:1.5,sunColor:`#ffd089`,sunIntensity:2.2,sunPosition:[-5,11,7],groundColor:`#e0d8c0`,groundAccent:`#a89070`,railColor:`#a89070`,cubePalette:[{bg:`#fff4cc`,fg:`#c8a230`},{bg:`#ffe7d4`,fg:`#cc3a3a`},{bg:`#dff0ff`,fg:`#3a7ac8`}],buildDecorations(e,t){for(let[t,n]of[[-13,-10],[13,-10],[-13,10],[13,10]]){Zl(e,t,n,`#cc3a3a`);let r=new q(new gi(.5,.6,4),$(`#ffd066`,{roughness:.4,metalness:.5,emissive:`#ffd066`,emissiveIntensity:.18}));r.position.set(t,3.5,n),r.rotation.y=Math.PI/4,e.add(r)}for(let[t,n]of[[-10,0],[10,0]]){let r=new q(new J(.32,.4,.4,12),$(`#7a6a5a`,{roughness:.8}));r.position.set(t,.2,n),e.add(r);let i=new q(new J(.12,.12,1,8),$(`#7a6a5a`,{roughness:.8}));i.position.set(t,.9,n),e.add(i);let a=new q(new pi(.6,.18,.6),$(`#7a6a5a`,{roughness:.8}));a.position.set(t,1.5,n),e.add(a);let o=new q(new gi(.36,.4,4),$(`#7a6a5a`,{roughness:.8}));o.position.set(t,1.78,n),o.rotation.y=Math.PI/4,e.add(o);let s=new q(new Y(.12,8,8),$(`#ff8a4a`,{emissive:`#ff8a4a`,emissiveIntensity:.9}));s.position.set(t,1.7,n),e.add(s)}}},{id:`garden`,name:`花园派对`,subtitle:`情感品格`,icon:`🌷`,skyColor:`#dff5ff`,fogNear:22,fogFar:48,ambientSky:`#fff8e0`,ambientGround:`#a0d870`,ambientIntensity:1.7,sunColor:`#fff4d6`,sunIntensity:2.4,sunPosition:[-5,12,7],groundColor:`#9be37a`,groundAccent:`#ff7eb9`,railColor:`#ffc1d6`,cubePalette:[{bg:`#fff0f5`,fg:`#ff5a8a`},{bg:`#fffce8`,fg:`#ffb347`},{bg:`#e8f8ff`,fg:`#5fb1f5`}],buildDecorations(e,t){let n=[`#ff7eb9`,`#ffb347`,`#c8b6f8`,`#ff5a5a`,`#ffd66b`,`#ffffff`];for(let r=0;r<30;r+=1){let[r,i]=Kl(t),a=n[Math.floor(t()*n.length)]??`#ff7eb9`,o=new q(new J(.03,.03,.5,6),$(`#5fa84a`,{roughness:.7}));o.position.set(r,.25,i),e.add(o);let s=new q(new Y(Q(t,.12,.2),10,8),$(a,{roughness:.6}));s.position.set(r,.55,i),e.add(s)}for(let n=0;n<8;n+=1){let[n,r]=ql(t),i=new q(new Y(Q(t,.6,1),12,8),$(`#6ab04a`,{roughness:.85}));i.position.set(n,Q(t,.4,.6),r),i.scale.y=.7,i.castShadow=!0,e.add(i)}let r=[[-12,-8],[12,-8],[-13,9],[13,9]],i=[`#ff5a5a`,`#5fb1f5`,`#ffb347`,`#c8b6f8`];for(let t=0;t<r.length;t+=1){let[n,a]=r[t],o=i[t]??`#ff5a5a`,s=new q(new gi(.22,.55,10),$(o,{roughness:.7}));s.position.set(n,.7,a),e.add(s);let c=new q(new Y(.18,10,8),$(`#ffffff`,{roughness:.6}));c.position.set(n,.35,a),e.add(c);let l=new q(new J(.15,.18,.35,10),$(`#5a4a3a`,{roughness:.8}));l.position.set(n,.18,a),e.add(l)}let a=new q(new J(.9,1.1,.35,14),$(`#d4d4d4`,{roughness:.5}));a.position.set(0,.18,-14),e.add(a);let o=new q(new J(.18,.22,1,12),$(`#d4d4d4`,{roughness:.5}));o.position.set(0,.85,-14),e.add(o);let s=new q(new J(.45,.4,.12,14),$(`#d4d4d4`,{roughness:.5}));s.position.set(0,1.4,-14),e.add(s);for(let t=0;t<3;t+=1){let n=new q(new Y(.08,8,6),new zr({color:`#aaccff`,transparent:!0,opacity:.75}));n.position.set(Math.cos(t*2.1)*.3,1.8+t*.2,-14+Math.sin(t*2.1)*.3),e.add(n)}}},{id:`bazaar`,name:`热闹市集`,subtitle:`节日神话`,icon:`🛍️`,skyColor:`#ffe5b8`,fogNear:22,fogFar:48,ambientSky:`#fff4d6`,ambientGround:`#d8a040`,ambientIntensity:1.6,sunColor:`#ffd066`,sunIntensity:2.4,sunPosition:[4,12,6],groundColor:`#e8c890`,groundAccent:`#cc6a3a`,railColor:`#a06030`,cubePalette:[{bg:`#fff4cc`,fg:`#cc6a3a`},{bg:`#ffe7d4`,fg:`#3aa5d9`},{bg:`#fff0e8`,fg:`#ff5a8a`}],buildDecorations(e,t){let n=[`#ff5a3a`,`#ffd066`,`#7eb27a`,`#cc3a3a`,`#ff7eb9`,`#a87832`],r=[`#cc3a3a`,`#3a8acc`,`#ffb347`,`#5fb1f5`,`#7eb27a`],i=[`#ff5a5a`,`#ffd066`,`#ff7eb9`,`#5fb1f5`,`#7eb27a`];for(let a=0;a<5;a+=1){let[o,s]=Kl(t),c=r[a]??`#cc3a3a`,l=i[a]??`#ffd066`;for(let t=-.7;t<=.7;t+=1.4)for(let n=-.4;n<=.4;n+=.8){let r=new q(new J(.06,.06,.8,6),$(`#5a3a20`,{roughness:.9}));r.position.set(o+t,.4,s+n),e.add(r)}let u=new q(new pi(1.6,.1,1),$(c,{roughness:.7}));u.position.set(o,.85,s),e.add(u);let d=new q(new gi(1.05,.7,4),$(l,{roughness:.6}));d.position.set(o,1.85,s),d.rotation.y=Math.PI/4,e.add(d);for(let t=-.7;t<=.7;t+=1.4){let n=new q(new J(.025,.025,1,4),$(`#5a3a20`,{roughness:.9}));n.position.set(o+t,1.4,s),e.add(n)}for(let r=0;r<5;r+=1){let r=new q(new Y(Q(t,.11,.18),8,6),$(n[Math.floor(t()*n.length)]??`#ff5a3a`,{roughness:.4}));r.position.set(o+Q(t,-.6,.6),1,s+Q(t,-.35,.35)),e.add(r)}}for(let r=0;r<8;r+=1){let[r,i]=Kl(t),a=new q(new J(.35,.28,.3,10),$(`#a87832`,{roughness:.9}));a.position.set(r,.15,i),e.add(a);let o=n[Math.floor(t()*n.length)]??`#ff5a3a`;for(let n=0;n<3;n+=1){let a=new q(new Y(.12,8,6),$(o,{roughness:.5}));a.position.set(r+Q(t,-.2,.2),.4+n*.1,i+Q(t,-.2,.2)),e.add(a)}}let a=[`#ff5a5a`,`#ffd066`,`#5fb1f5`,`#7eb27a`],o=[[-13,-11],[13,-11],[-14,10],[14,10]];for(let t=0;t<o.length;t+=1){let[n,r]=o[t],i=a[t]??`#ff5a5a`,s=new q(new J(.04,.04,3.5,6),$(`#5a3a20`,{roughness:.8}));s.position.set(n,1.75,r),e.add(s);let c=new q(new yi(.7,.45),$(i,{roughness:.5,side:2}));c.position.set(n+.4,3,r),e.add(c)}let s=new q(new J(.6,.6,.7,14),$(`#a89070`,{roughness:.8}));s.position.set(0,.35,-14),e.add(s);let c=new q(new J(.65,.65,.1,14),$(`#5a3a20`,{roughness:.7}));c.position.set(0,.75,-14),e.add(c);for(let t=-.45;t<=.45;t+=.9){let n=new q(new J(.05,.05,1.5,6),$(`#5a3a20`,{roughness:.8}));n.position.set(t,1.55,-14),e.add(n)}let l=new q(new J(.05,.05,1,6),$(`#5a3a20`,{roughness:.8}));l.rotation.z=Math.PI/2,l.position.set(0,2.25,-14),e.add(l),Ql(e,-8,8,-5,1),Ql(e,6,9,-7,.9)}},{id:`theater`,name:`戏楼戏台`,subtitle:`文艺学科`,icon:`🎭`,skyColor:`#3a2a4a`,fogNear:22,fogFar:50,ambientSky:`#d4a878`,ambientGround:`#4a3a3a`,ambientIntensity:1.2,sunColor:`#ffd066`,sunIntensity:2.2,sunPosition:[0,14,6],groundColor:`#a89070`,groundAccent:`#cc3a3a`,railColor:`#5a3a30`,cubePalette:[{bg:`#ffe7d4`,fg:`#cc3a3a`},{bg:`#fff4cc`,fg:`#d8a230`},{bg:`#fff0e8`,fg:`#8a4a3a`}],buildDecorations(e,t){let n=new q(new pi(8,.4,4),$(`#8a6a4a`,{roughness:.7}));n.position.set(0,.2,-12),n.castShadow=!0,e.add(n);let r=$(`#cc3a3a`,{roughness:.7,side:2}),i=new yi(3,4,1,6);for(let t of[-1,1]){let n=new q(i,r);n.position.set(t*4.2,2.4,-12.01),e.add(n)}let a=new q(new pi(8.5,.2,4.5),$(`#cc3a3a`,{roughness:.6}));a.position.set(0,4.7,-12),e.add(a);for(let t of[-1,1]){let n=new q(new gi(.5,1,4),$(`#ffd066`,{roughness:.5,metalness:.4}));n.position.set(t*4.3,5.4,-12),n.rotation.y=Math.PI/4,e.add(n)}let o=new zr({color:`#ffd066`,transparent:!0,opacity:.2,side:2,depthWrite:!1});for(let t of[-1,1]){let n=new q(new gi(1.2,6,16,1,!0),o);n.position.set(t*6,4,-8),n.rotation.z=t*.4,n.rotation.x=Math.PI,e.add(n)}}},{id:`workshop`,name:`工匠作坊`,subtitle:`器物工具`,icon:`🔨`,skyColor:`#c8b89a`,fogNear:22,fogFar:48,ambientSky:`#ffe8c0`,ambientGround:`#7a5a3a`,ambientIntensity:1.5,sunColor:`#ffd066`,sunIntensity:2.2,sunPosition:[-6,11,7],groundColor:`#8a6a4a`,groundAccent:`#3a2a1a`,railColor:`#5a3a2a`,cubePalette:[{bg:`#fff4cc`,fg:`#a8721c`},{bg:`#e1e8ff`,fg:`#3a3a4a`},{bg:`#ffe7d4`,fg:`#cc6a3a`}],buildDecorations(e,t){let n=new q(new pi(1.4,.6,.8),$(`#3a3a4a`,{roughness:.6,metalness:.6}));n.position.set(-12,.3,-8),e.add(n);let r=new q(new pi(1.6,.25,1),$(`#4a4a5a`,{roughness:.5,metalness:.7}));r.position.set(-12,.75,-8),e.add(r);for(let[t,n]of[[12,-9],[-13,9]]){let r=new q(new xi(.9,.18,8,16),$(`#7a7a8a`,{roughness:.5,metalness:.7}));r.position.set(t,1,n),r.rotation.x=Math.PI/2,e.add(r);let i=new q(new J(.32,.32,.18,14),$(`#7a7a8a`,{roughness:.5,metalness:.7}));i.position.set(t,1,n),e.add(i);for(let r=0;r<8;r+=1){let i=r/8*Math.PI*2,a=new q(new pi(.16,.16,.32),$(`#7a7a8a`,{roughness:.5,metalness:.7}));a.position.set(t+Math.cos(i)*1.1,1,n+Math.sin(i)*1.1),a.rotation.y=-i,e.add(a)}}for(let[t,n]of[[12,9],[-13,-9]]){let r=new q(new J(.4,.4,.9,14),$(`#7a4a2a`,{roughness:.95}));r.position.set(t,.45,n),e.add(r);let i=new q(new xi(.41,.04,6,18),$(`#3a2a1a`,{roughness:.6,metalness:.4}));i.rotation.x=Math.PI/2,i.position.set(t,.65,n),e.add(i);let a=i.clone();a.position.set(t,.25,n),e.add(a)}}},{id:`kitchen`,name:`热闹厨房`,subtitle:`饮食烹饪`,icon:`🍳`,skyColor:`#fff0d4`,fogNear:22,fogFar:48,ambientSky:`#fff4d6`,ambientGround:`#a89070`,ambientIntensity:1.55,sunColor:`#ffe089`,sunIntensity:2.2,sunPosition:[-6,11,7],groundColor:`#e8d8b8`,groundAccent:`#a89070`,railColor:`#a89070`,cubePalette:[{bg:`#fff4cc`,fg:`#d8a230`},{bg:`#ffe7d4`,fg:`#cc6a3a`},{bg:`#f0e8d4`,fg:`#a8721c`}],buildDecorations(e,t){let n=new q(new pi(3,1,1.4),$(`#a89070`,{roughness:.8}));n.position.set(0,.5,-12),e.add(n);let r=new q(new J(.5,.45,.5,16,1,!0),$(`#3a2a1a`,{roughness:.6,metalness:.4,side:2}));r.position.set(0,1.25,-12),e.add(r);let i=new zr({color:`#ffffff`,transparent:!0,opacity:.55});for(let n=0;n<3;n+=1){let r=new q(new gi(.18,1.4,8),i);r.position.set((t()-.5)*.4,2.2+n*.6,-12+(t()-.5)*.4),e.add(r)}for(let[t,n]of[[-12,0],[12,0]]){let r=new q(new pi(1.6,.1,1.6),$(`#cc6a3a`,{roughness:.7}));r.position.set(t,.85,n),e.add(r);for(let r of[-.7,.7])for(let i of[-.7,.7]){let a=new q(new J(.06,.06,.85,6),$(`#cc6a3a`,{roughness:.7}));a.position.set(t+r,.425,n+i),e.add(a)}let i=new q(new Y(.22,14,10,0,Math.PI*2,0,Math.PI/2),$(`#ffffff`,{roughness:.4}));i.position.set(t,.97,n),e.add(i)}for(let n=0;n<4;n+=1){let r=new q(new mi(.07,.32,6,8),$(`#cc3a3a`,{roughness:.5,emissive:`#cc3a3a`,emissiveIntensity:.2}));r.position.set(-13,3.5+(t()-.5)*.4,-6+n*4),r.rotation.z=.2,e.add(r)}}},{id:`skyGarden`,name:`天空花园`,subtitle:`抽象概念`,icon:`☁️`,skyColor:`#ffe5f0`,fogNear:22,fogFar:48,ambientSky:`#fff8f8`,ambientGround:`#a0d870`,ambientIntensity:1.6,sunColor:`#fff4d6`,sunIntensity:2.2,sunPosition:[-3,12,6],groundColor:`#f8e8f8`,groundAccent:`#ff7eb9`,railColor:`#c8b6f8`,cubePalette:[{bg:`#fff0f5`,fg:`#ff7eb9`},{bg:`#fff8e0`,fg:`#ffb347`},{bg:`#e8f0ff`,fg:`#9a5ad0`}],buildDecorations(e,t){Ql(e,-10,7,-5,1.3),Ql(e,10,8,-5,1.2),Ql(e,-8,9,8,1.1),Ql(e,9,7.5,7,1);let n=[[-15,5,-10],[15,4,-10],[-13,6,12],[13,5,12],[0,7,-16]],r=[`#ff7eb9`,`#ffb347`,`#c8b6f8`,`#ffffff`,`#ff5a5a`];for(let[i,a,o]of n){let n=new q(new gi(1.5,1,14),$(`#caa66a`,{roughness:.85}));n.position.set(i,a-.5,o),n.rotation.x=Math.PI,e.add(n);let s=new q(new J(1.5,1.5,.18,14),$(`#7eb27a`,{roughness:.9}));s.position.set(i,a+.05,o),e.add(s);for(let n=0;n<2;n+=1){let n=new q(new Y(.18,8,6),$(r[Math.floor(t()*r.length)]??`#ff7eb9`,{roughness:.6}));n.position.set(i+Q(t,-.8,.8),a+.3,o+Q(t,-.8,.8)),e.add(n)}t()>.5&&Jl(e,i+Q(t,-.6,.6),o+Q(t,-.6,.6),{trunkColor:`#6e4a2c`,leafColor:`#5fb1f5`,leafShape:`sphere`,scale:.6})}let i=[`#ff5a5a`,`#ffd066`,`#5fb1f5`];for(let n=0;n<3;n+=1){let[r,a]=Kl(t),o=i[n]??`#ff5a5a`,s=new q(new Y(.7,16,12),$(o,{roughness:.4}));s.position.set(r,4.6,a),s.scale.y=1.3,e.add(s);let c=new q(new pi(.4,.25,.4),$(`#a87832`,{roughness:.8}));c.position.set(r,3,a),e.add(c);for(let t=-.18;t<=.18;t+=.36)for(let n=-.18;n<=.18;n+=.36){let i=new q(new J(.01,.01,1.3,4),$(`#5a3a20`,{roughness:.8}));i.position.set(r+t,3.75,a+n),e.add(i)}}let a=[`#ff5a5a`,`#ffd066`,`#7eb27a`,`#5fb1f5`,`#c8b6f8`];for(let t=0;t<2;t+=1){let n=-14+t*4;for(let t=0;t<a.length;t+=1){let r=new q(new xi(2+t*.15,.08,6,14,Math.PI),$(a[t]??`#ff5a5a`,{roughness:.5}));r.position.set(0,3.5+t*.15,n),r.rotation.x=Math.PI,e.add(r)}}let o=[`#ff7eb9`,`#ffb347`,`#c8b6f8`,`#5fb1f5`];for(let n=0;n<6;n+=1){let[n,r]=Kl(t),i=o[Math.floor(t()*o.length)]??`#ff7eb9`,a=new q(new hi(.18,6),$(i,{roughness:.5,side:2}));a.position.set(n+.1,3.5+t()*.5,r),a.rotation.y=.3,e.add(a);let s=a.clone();s.position.set(n-.1,3.5+t()*.5,r),s.rotation.y=-.3,e.add(s)}}}];function nu(e,t){if(tu.length===0)throw Error(`SCENE_THEMES is empty`);return tu[Math.floor(e/5)%tu.length]||tu[0]}function ru(e){e.traverse(e=>{let t=e;t.geometry&&t.geometry.dispose();let n=Array.isArray(t.material)?t.material:t.material?[t.material]:[];for(let e of n)iu(e)})}function iu(e){let t=Object.values(e);for(let e of t)au(e)&&e.dispose();e.dispose()}function au(e){return!!(e&&typeof e==`object`&&e.isTexture)}var ou={halfWidth:9,halfDepth:6},su=[{bg:`#fff4d6`,fg:`#ff7a3d`},{bg:`#dff3ff`,fg:`#3aa5d9`},{bg:`#f0e4ff`,fg:`#8c6cd9`}],cu={minX:-7.5,maxX:7.5,minZ:-5,maxZ:-1},lu=4.5,uu=2.6,du=class{canvas;renderer;scene=new Pn;camera=new ua(46,1,.1,80);input;gamepad=new $c;player=new pl;collision=new gl;audio=new ml;speech=new Al;hud=new kl(Fl[0]?.rounds.length??5);cameraRig=new hl(this.camera);loop=new tl((e,t)=>this.update(e,t),()=>this.render());cubes=[];themeGroup=new Tn;touchCamera=null;hintShownThisRun=!1;gamepadHintShownThisRun=!1;gamepadCameraYawSpeed=1.6;gamepadCameraPitchSpeed=1.2;gamepadCameraInput=new H;stages=Fl;costumes=[];currentStageIndex=0;roundIndex=0;lastStageIndex=0;phase=`loading`;completedStages=new Set;completedWords=[];selectedCostumeId=null;phaseBeforeOutfit=null;savedCelebration=null;lastUnlockedCostumeName=void 0;frame=0;pausedForScreenshot=!1;reducedMotion=!1;roundTransitionTimer=0;currentThemeIndex=-1;cubePalette=su;rand=Ml(12648430);hemi=new Qi(`#fff7d6`,`#a8d8ff`,1.6);sun=new pa(`#fff1bf`,2.2);constructor(e){this.canvas=e,this.renderer=nl(e),this.renderer.toneMappingExposure=1;let t=this.getElement(`#touch-stick`),n=this.getElement(`#touch-knob`);this.input=new Yc(t,n,this.getElement(`#dash-button`)),this.input.setGamepad(this.gamepad),this.completedStages=Vl(),this.lastStageIndex=Math.max(0,Wl(0)),this.selectedCostumeId=wl(),this.createScene(),this.cameraRig.snapTo(this.player.group.position),rl(this.renderer,this.camera,2),this.hud.bindStart(()=>this.startStage(this.firstUnplayedStage())),this.hud.bindRestart(()=>this.startStage(this.currentStageIndex)),this.hud.bindStageSelect(e=>this.startStage(e)),this.hud.bindNextStage(()=>this.advanceToNextStage()),this.hud.bindBackToList(()=>this.backToLevelSelect()),this.hud.bindHintDismiss(()=>this.dismissMobileHint(!0)),this.hud.bindGamepadHintDismiss(()=>this.dismissGamepadHint(!0)),this.hud.bindPromptTap(()=>this.speakCurrentPrompt()),this.hud.bindCostumeSelect(e=>this.applyCostume(e)),this.hud.bindOutfitBack(()=>this.closeOutfitPicker()),this.hud.bindOutfitFab(()=>this.toggleOutfitFromFab()),this.hud.bindBackFab(()=>this.backToLevelSelect()),this.gamepad.onStatusChange(e=>{this.hud.setGamepadConnected(e.connected),e.connected?this.maybeShowGamepadHint():this.hud.hideGamepadHint()}),this.touchCamera=new jl(this.canvas,(e,t)=>{this.cameraRig.rotate(e,t)},{onDragStart:()=>{this.hintShownThisRun&&this.dismissMobileHint(!1)}}),this.installTestHooks(),this.publishDiagnostics()}stageSummaries(){return this.stages.map(e=>({id:e.id,title:e.title,subtitle:e.subtitle,icon:e.icon,theme:e.theme,themeName:e.themeName,themeSubtitle:e.themeSubtitle}))}firstUnplayedStage(){let e=fu(this.lastStageIndex,this.stages.length);if(!this.completedStages.has(e))return e;for(let e=0;e<this.stages.length;e+=1)if(!this.completedStages.has(e))return e;return 0}currentStage(){return this.stages[this.currentStageIndex]??this.stages[0]}currentRounds(){return this.currentStage().rounds}isCoarsePointer(){return typeof window>`u`?!1:window.matchMedia(`(pointer: coarse)`).matches}dismissMobileHint(e){if(this.hintShownThisRun&&(this.hintShownThisRun=!1,this.hud.hideMobileHint(),e))try{localStorage.setItem(`literacy-town.mobile-hint.seen`,`1`)}catch{}}async start(){try{let e=await Bl();this.stages=e,this.lastStageIndex=fu(this.lastStageIndex,e.length),this.currentStageIndex=fu(this.currentStageIndex,e.length)}catch{this.stages=Fl}try{this.costumes=await xl()}catch{this.costumes=[]}this.player.setCostume(this.currentCostume()),this.showLevelSelect(),this.hud.setOutfitFabVisible(!0),this.loop.start()}dispose(){this.loop.stop(),this.input.dispose(),this.gamepad.dispose(),this.audio.dispose(),this.speech.dispose(),this.touchCamera?.dispose();for(let e of this.cubes)e.dispose();for(ru(this.themeGroup);this.themeGroup.children.length>0;)this.themeGroup.remove(this.themeGroup.children[0]);this.player.dispose(),this.renderer.dispose(),window.__THREE_GAME_DIAGNOSTICS__=void 0,window.__THREE_GAME_TEST_HOOKS__=void 0}update(e,t){if(this.frame+=1,this.pausedForScreenshot){this.publishDiagnostics();return}rl(this.renderer,this.camera,2),this.gamepad.poll();let n=this.gamepad.consumeEdges(),r=this.reducedMotion?0:e,i=this.reducedMotion?0:t;if(this.handleGlobalGamepadEdges(n),(this.phase===`playing`||this.phase===`round-complete`)&&(this.gamepad.readCameraDelta(this.gamepadCameraInput),this.gamepadCameraInput.lengthSq()>0)){let t=-this.gamepadCameraInput.x*this.gamepadCameraYawSpeed*e,n=-this.gamepadCameraInput.y*this.gamepadCameraPitchSpeed*e;this.cameraRig.rotate(t,n)}this.player.update(e,i,this.input,{speed:5.6,acceleration:12},ou,this.cameraRig.getYaw());for(let e of this.cubes)e.update(r,i);this.phase===`playing`&&this.checkCubeCollisions(),this.phase===`round-complete`&&(this.roundTransitionTimer-=e,this.roundTransitionTimer<=0&&this.advanceRound()),this.cameraRig.update(e,this.player.group.position,.16),this.publishDiagnostics()}render(){this.renderer.render(this.scene,this.camera)}createScene(){this.scene.background=new K(`#cfeaff`),this.scene.fog=new Nn(`#cfeaff`,22,48),this.scene.add(this.hemi),this.scene.add(this.sun),this.sun.position.set(-6,11,7),this.sun.castShadow=!0,this.sun.shadow.mapSize.set(2048,2048),this.sun.shadow.camera.near=.5,this.sun.shadow.camera.far=32,this.sun.shadow.camera.left=-14,this.sun.shadow.camera.right=14,this.sun.shadow.camera.top=12,this.sun.shadow.camera.bottom=-12,this.scene.add(this.themeGroup),this.scene.add(this.player.group),this.createCubes()}applySceneTheme(e){let t=nu(e,this.stages.length),n=Math.floor(e/5);if(n!==this.currentThemeIndex){for(this.currentThemeIndex=n,ru(this.themeGroup);this.themeGroup.children.length>0;)this.themeGroup.remove(this.themeGroup.children[0]);this.scene.background=new K(t.skyColor),this.scene.fog=new Nn(t.skyColor,t.fogNear,t.fogFar),this.hemi.color.set(t.ambientSky),this.hemi.groundColor.set(t.ambientGround),this.hemi.intensity=t.ambientIntensity,this.sun.color.set(t.sunColor),this.sun.intensity=t.sunIntensity,this.sun.position.set(t.sunPosition[0],t.sunPosition[1],t.sunPosition[2]),this.themeGroup.add(this.createArena(t)),t.buildDecorations(this.themeGroup,this.rand),this.cubePalette=t.cubePalette}}createArena(t){let n=new Tn,r=this.createGroundTexture(t.groundColor,t.groundAccent);r.wrapS=e,r.wrapT=e,r.repeat.set(ou.halfWidth/2,ou.halfDepth/2);let i=new q(new yi(ou.halfWidth*2,ou.halfDepth*2),new Mi({color:t.groundColor,map:r,roughness:.92,metalness:0}));i.rotation.x=-Math.PI/2,i.receiveShadow=!0,n.add(i);let a=new Mi({color:t.railColor,roughness:.7}),o=new pi(ou.halfWidth*2,.18,.18),s=[new q(o,a),new q(o,a)];s[0].position.set(0,.45,-ou.halfDepth-.3),s[1].position.set(0,.45,ou.halfDepth+.3),s.forEach(e=>{e.castShadow=!0,n.add(e)});let c=new pi(.18,.18,ou.halfDepth*2),l=[new q(c,a),new q(c,a)];l[0].position.set(-ou.halfWidth-.3,.45,0),l[1].position.set(ou.halfWidth+.3,.45,0),l.forEach(e=>{e.castShadow=!0,n.add(e)});let u=new Y(.32,12,8),d=new Mi({color:`#d0d0d8`,roughness:.9}),f=[[-ou.halfWidth+.6,-ou.halfDepth+.6],[ou.halfWidth-.6,-ou.halfDepth+.6],[-ou.halfWidth+.6,ou.halfDepth-.6],[ou.halfWidth-.6,ou.halfDepth-.6]];for(let[e,t]of f){let r=new q(u,d);r.position.set(e,.18,t),r.scale.set(1,.6,1),r.castShadow=!0,r.receiveShadow=!0,n.add(r)}return n}createCubes(){for(let e=0;e<3;e+=1){let t=new cl(`?`,new U(-5.6+e*5.6,1.1,-2.5),this.cubePalette[e%this.cubePalette.length]??su[0],0,e*1.7);this.cubes.push(t),this.scene.add(t.group)}}createGroundTexture(e,t){let n=document.createElement(`canvas`);n.width=256,n.height=256;let r=n.getContext(`2d`);if(!r)throw Error(`ground texture context failed`);r.fillStyle=e,r.fillRect(0,0,256,256);let i=pu(e),a=mu(hu(i,.18)),o=mu(gu(i,.16));for(let e=0;e<320;e+=1){let e=this.rand()*256,t=this.rand()*256;r.fillStyle=this.rand()>.5?a:o,r.fillRect(e,t,2,2)}for(let e=0;e<14;e+=1){let e=this.rand()*256,n=this.rand()*256;r.fillStyle=t,r.beginPath(),r.arc(e,n,3,0,Math.PI*2),r.fill()}let s=new li(n);return s.colorSpace=Le,s}showLevelSelect(){this.phase=`level-select`,this.roundIndex=0,this.completedWords=[],this.lastUnlockedCostumeName=void 0,this.phaseBeforeOutfit=null,this.savedCelebration=null,this.hud.showLevelSelect(this.stageSummaries(),this.completedStages,this.lastStageIndex),this.hud.setOutfitFabVisible(!0),this.hud.setBackFabVisible(!1)}startStage(e){let t=fu(e,this.stages.length);t<0||t>=this.stages.length||(this.currentStageIndex=t,this.lastStageIndex=t,Gl(t),this.roundIndex=0,this.completedWords=[],this.lastUnlockedCostumeName=void 0,this.phaseBeforeOutfit=null,this.savedCelebration=null,this.hud.hideOverlay(),this.phase=`playing`,this.applySceneTheme(t),this.player.reset(),this.player.setCostume(this.currentCostume()),this.cameraRig.setAngles(0,.55),this.applyCurrentRound(),this.maybeShowMobileHint(),this.hud.setOutfitFabVisible(!0),this.hud.setBackFabVisible(!0))}advanceToNextStage(){let e=this.currentStageIndex+1;e<this.stages.length?this.startStage(e):this.backToLevelSelect()}backToLevelSelect(){this.speech.cancel(),this.showLevelSelect()}speakCurrentPrompt(){let e=this.currentRounds()[this.roundIndex];e&&(this.speech.speakGlyph(e.word),this.hud.flashPrompt())}maybeShowMobileHint(){if(!this.isCoarsePointer())return;let e=!1;try{e=localStorage.getItem(`literacy-town.mobile-hint.seen`)===`1`}catch{}e||(this.hintShownThisRun=!0,this.hud.showMobileHint())}maybeShowGamepadHint(){if(this.gamepadHintShownThisRun||!this.gamepad.getStatus().connected)return;let e=!1;try{e=localStorage.getItem(`literacy-town.gamepad-hint.seen`)===`1`}catch{}e||(this.gamepadHintShownThisRun=!0,this.hud.showGamepadHint())}dismissGamepadHint(e){if(this.gamepadHintShownThisRun&&(this.gamepadHintShownThisRun=!1,this.hud.hideGamepadHint(),e))try{localStorage.setItem(`literacy-town.gamepad-hint.seen`,`1`)}catch{}}handleGlobalGamepadEdges(e){if(this.phase===`outfit`){if(e.next||e.prev){let t=e.next?1:-1;this.cycleCostume(t)}}else if(this.phase===`level-select`&&(e.next||e.prev)){let t=e.next?1:-1;this.hud.focusStepColumn(t)}this.hud.applyGamepadEdges(e),(this.phase===`playing`||this.phase===`round-complete`)&&(e.toggle&&this.toggleOutfitFromFab(),e.start&&this.speakCurrentPrompt())}cycleCostume(e){if(this.costumes.length===0)return;let t=this.costumes.filter(e=>e.unlock<=this.completedStages.size);if(t.length===0)return;let n=t[(t.findIndex(e=>e.id===this.selectedCostumeId)+e+t.length)%t.length];n&&this.applyCostume(n.id)}applyCurrentRound(){let e=this.currentRounds(),t=e[this.roundIndex];if(!t)return;let n=Nl({spawn:cu,playerPosition:this.player.group.position,cubeCount:t.choices.length,minDistanceFromPlayer:lu,minDistanceBetweenCubes:uu});t.choices.forEach((e,t)=>{let r=this.cubes[t],i=n[t];if(!r||!i)return;let a=this.cubePalette[t%this.cubePalette.length]??su[0];r.reset(i.position,e,i.rotationY),r.color=a,r.bobPhase=i.bobPhase,r.setEffect(il(e))}),this.hud.setRound(t,this.roundIndex,e.length),this.speech.announceRound({word:t.word,pinyin:t.pinyin})}checkCubeCollisions(){let e=this.cubes.filter(e=>e.active),t=this.collision.collectTargets(this.player.group.position,.5,e);if(t.length===0)return;let n=t[0],r=this.currentRounds()[this.roundIndex];r&&(n.glyph===r.word[0]?this.correctPick(n):(n.reject(),this.audio.wrong(),this.hud.setWrongHint(n.glyph)))}correctPick(e){if(!this.currentRounds()[this.roundIndex])return;let t=new U(this.player.group.position.x,6.5,-2);e.collect(t),this.audio.correct(),this.speech.speakGlyph(e.glyph),this.hud.fillCharSlot(0,e.glyph),this.hud.setCorrectHint(e.glyph),this.phase=`round-complete`,this.roundTransitionTimer=.9}advanceRound(){let e=this.currentRounds(),t=e[this.roundIndex];if(t){if(this.completedWords.push(t.word),this.hud.markRoundDone(this.roundIndex),this.audio.word(),this.hud.setRoundComplete(t.word),this.roundIndex+=1,this.roundIndex>=e.length){let e=this.completedStages.size;this.completedStages.add(this.currentStageIndex),Hl(this.completedStages);let t=this.detectNewlyUnlockedCostume(e);this.lastUnlockedCostumeName=t??void 0,this.phase=`all-done`,this.audio.allDone(),this.speech.speakCelebration(this.completedWords);let n=this.stages[this.currentStageIndex+1],r=!!n,i=this.currentStageIndex;setTimeout(()=>{this.phase!==`all-done`||this.currentStageIndex!==i||(this.hud.showCelebration({words:this.completedWords,hasNextStage:r,nextStageTitle:n?.title,unlockedCostumeName:this.lastUnlockedCostumeName}),this.hud.setOutfitFabVisible(!0),this.hud.setBackFabVisible(!1))},1200);return}this.phase=`playing`,this.applyCurrentRound()}}detectNewlyUnlockedCostume(e){if(this.costumes.length===0)return null;let t=this.completedStages.size;return t<=e?null:this.costumes.find(n=>n.unlock>e&&n.unlock<=t)?.name??null}currentCostume(){return this.costumes.length===0?null:Sl(this.costumes,this.selectedCostumeId)}applyCostume(e){this.selectedCostumeId=e,Tl(e);let t=this.currentCostume();this.player.setCostume(t),this.phase===`outfit`&&this.hud.showOutfitPicker(this.costumes,e,this.completedStages.size,this.outfitBackLabel(this.phaseBeforeOutfit))}toggleOutfitFromFab(){if(this.phase===`outfit`){this.closeOutfitPicker();return}this.openOutfitPicker()}outfitBackLabel(e){switch(e){case`playing`:case`round-complete`:return`← 返回游戏`;case`all-done`:return`← 返回`;default:return`← 返回关卡`}}openOutfitPicker(){if(this.phase!==`outfit`&&this.costumes.length!==0){if(this.phaseBeforeOutfit=this.phase,this.phase===`all-done`){let e=this.stages[this.currentStageIndex+1];this.savedCelebration={words:[...this.completedWords],hasNextStage:!!e,nextStageTitle:e?.title,unlockedCostumeName:this.lastUnlockedCostumeName}}this.phase=`outfit`,this.speech.cancel(),this.hud.showOutfitPicker(this.costumes,this.selectedCostumeId,this.completedStages.size,this.outfitBackLabel(this.phaseBeforeOutfit)),this.hud.setOutfitFabVisible(!1),this.hud.setBackFabVisible(!1)}}closeOutfitPicker(){if(this.phase!==`outfit`)return;let e=this.phaseBeforeOutfit,t=this.savedCelebration;if(this.phaseBeforeOutfit=null,this.savedCelebration=null,this.hud.hideOverlay(),e===`all-done`&&t){this.phase=`all-done`,this.hud.showCelebration(t),this.hud.setOutfitFabVisible(!0),this.hud.setBackFabVisible(!1);return}if(e===`playing`||e===`round-complete`){this.phase=e,this.hud.setOutfitFabVisible(!0),this.hud.setBackFabVisible(!0);return}this.phase=`level-select`,this.showLevelSelect(),this.hud.setOutfitFabVisible(!0)}installTestHooks(){window.__THREE_GAME_TEST_HOOKS__={seed:e=>{},setState:e=>{if(e===`title`)this.showLevelSelect();else if(e===`outfit`)this.openOutfitPicker(),this.render();else if(e===`active-play`)this.phase===`level-select`||this.phase===`all-done`||this.phase===`loading`||this.phase===`outfit`?this.startStage(this.firstUnplayedStage()):(this.hud.hideOverlay(),this.phase=`playing`,this.hud.setBackFabVisible(!0)),this.render();else if(e===`round-complete`)this.phase=`round-complete`,this.roundTransitionTimer=.001,this.render();else if(e===`all-done`){this.phase=`all-done`,this.completedWords=this.currentRounds().map(e=>e.word),this.completedStages.add(this.currentStageIndex),Hl(this.completedStages);let e=this.detectNewlyUnlockedCostume(this.completedStages.size-1);this.lastUnlockedCostumeName=e??void 0;let t=this.stages[this.currentStageIndex+1],n=!!t;this.hud.showCelebration({words:this.completedWords,hasNextStage:n,nextStageTitle:t?.title,unlockedCostumeName:e??void 0}),this.hud.setOutfitFabVisible(!0),this.hud.setBackFabVisible(!1),this.render()}else throw Error(`Unknown test state: ${e}`);return this.publishDiagnostics(),{state:e}},setPausedForScreenshot:e=>{this.pausedForScreenshot=e},setReducedMotion:e=>{if(this.reducedMotion=e,e){this.player.stabilizeVisuals();for(let e of this.cubes)e.stabilizeVisuals()}this.render(),this.publishDiagnostics()},hideDebugUi:e=>{}}}publishDiagnostics(){let e=this.renderer.info;window.__THREE_GAME_DIAGNOSTICS__={frame:this.frame,phase:this.phase,roundIndex:this.roundIndex,camera:{yaw:this.cameraRig.getYaw(),pitch:this.cameraRig.getPitch()},player:{position:{x:this.player.group.position.x,y:this.player.group.position.y,z:this.player.group.position.z},rotationY:this.player.group.rotation.y,speed:this.player.velocity.length()},cubes:this.cubes.map(e=>({glyph:e.glyph,active:e.active,x:Number(e.group.position.x.toFixed(2)),z:Number(e.group.position.z.toFixed(2))})),renderer:{calls:e.render.calls,triangles:e.render.triangles,geometries:e.memory.geometries,textures:e.memory.textures},canvas:{clientWidth:this.canvas.clientWidth,clientHeight:this.canvas.clientHeight,width:this.canvas.width,height:this.canvas.height,dpr:Math.min(window.devicePixelRatio||1,2)}}}getElement(e){let t=document.querySelector(e);if(!t)throw Error(`Missing element: ${e}`);return t}};function fu(e,t){return t<=0||!Number.isFinite(e)||e<0?0:e>=t?t-1:Math.floor(e)}function pu(e){let t=e.replace(`#`,``),n=t.length===3?t.split(``).map(e=>e+e).join(``):t,r=parseInt(n,16);return{r:r>>16&255,g:r>>8&255,b:r&255}}function mu(e){let t=Math.max(0,Math.min(255,Math.round(e.r))),n=Math.max(0,Math.min(255,Math.round(e.g))),r=Math.max(0,Math.min(255,Math.round(e.b))),i=e=>e.toString(16).padStart(2,`0`);return`#${i(t)}${i(n)}${i(r)}`}function hu(e,t){return{r:e.r*(1-t),g:e.g*(1-t),b:e.b*(1-t)}}function gu(e,t){return{r:e.r+(255-e.r)*t,g:e.g+(255-e.g)*t,b:e.b+(255-e.b)*t}}var _u=document.querySelector(`#game-canvas`);if(!_u)throw Error(`Missing #game-canvas element.`);new du(_u).start();
//# sourceMappingURL=index-6w6TFGwN.js.map